...
d]&&(f=this["onNew"+d](b));if(f===false)return this;c[a]=["filter","parser"].indexOf(a)!==-1&&this._isStringExpression(b)?this["_compile"+g.toUpperCase(a,1)](b):["target","pager"].indexOf(a)!==-1&&g.isString(b)?e.find.apply(e,g.isArray(b)?b:[b]):g.expr(b,c[a]||"");this.dObj.sys["active"+d+"Id"]=null;return this};Collection.prototype._update=function(a,b){var c=this.dObj.active,d=g.toUpperCase(a,1),f,e=this._getActiveId(a),i=g.drivers.dom;this["onUpdate"+d]&&(f=this["onUpdate"+d](b));if(f===false)return this;
...
function(a,b,c){var d=g.toUpperCase(a,1),f,e=this.dObj.sys["tmp"+d],i=this._getActiveId(a),k,l=g.drivers.dom;this["onPush"+d]&&(f=this["onPush"+d](b,c||""));if(f===false)return this;if(g.isPlainObject(b))for(k in b){if(b.hasOwnProperty(k))if(k===this.ACTIVE)this._update(a,b[k]);else if(e[k]&&i&&i===k)this._update(a,b[k]);else e[k]=["filter","parser"].indexOf(a)!==-1&&this._isStringExpression(b[k])?this["_compile"+d](b[k]):["target","pager"].indexOf(a)!==-1&&g.isString(b[k])?l.find.apply(l,g.isArray(b[k])?
b[k]:[b[k]]):b[k]}else if(b===this.ACTIVE)this._update(a,c);else if(e[b]&&i&&i===b)this._update(a,c);else e[b]=["filter","parser"].indexOf(a)!==-1&&this._isStringExpression(c)?this["_compile"+d](c):["target","pager"].indexOf(a)!==-1&&g.isString(c)?l.find.apply(l,g.isArray(c)?c:[c]):c;return this};Collection.prototype._set=function(a,b){if(!b||b===this.ACTIVE)return this;var c=this.dObj.sys,d=g.toUpperCase(a,1),f,e=a+"ChangeControl",i="active"+d+"Id";if(!this._exists(a,b))throw Error('the object "'+
b+'" -> "'+a+"\" doesn't exist in the stack!");this["onSet"+d]&&(f=this["onSet"+d](b));if(f===false)return this;if(c[i]!==b){c[e]=true;c[i]=b}else c[e]=false;c[a+"Back"].push(b);this.dObj.active[a]=c["tmp"+d][b];return this};Collection.prototype._back=function(a,b){b=b||1;var c=this.dObj.sys,d=g.toUpperCase(a,1),f,e=c[a+"Back"],i=e.length-b-1;this["onBack"+d]&&(f=this["onBack"+d](b));if(f===false)return this;if(i>=0&&e[i])if(c["tmp"+d][e[i]]){this._set(a,e[i]);c[a+"ChangeControl"]=false;e.splice(i+
1,e.length)}return this};Collection.prototype._backIf=function(a){if(this.dObj.sys[a+"ChangeControl"]===true)return this._back.apply(this,arguments);return this};Collection.prototype._drop=function(a,b,c,d){c=typeof c==="undefined"?false:c;var f=this.dObj.active,e=this.dObj.sys,i=g.toUpperCase(a,1),k,l="active"+i+"Id",n="tmp"+i,p=this._getActiveId(a),h=!b?p?[p]:[]:g.isArray(b)||g.isPlainObject(b)?b:[b],m;if(typeof d==="undefined")this["onDrop"+i]&&(k=this["onDrop"+i](b,c));else this["onReset"+i]&&
(k=this["onReset"+i](b,d));if(k===false)return this;if(h[0]&&h[0]!==this.ACTIVE)for(m in h){if(h.hasOwnProperty(m))if(!h[m]||h[m]===this.ACTIVE)if(typeof d==="undefined"){p&&delete e[n][p];e[l]=null;f[a]=c}else{if(p)e[n][p]=d;f[a]=d}else if(typeof d==="undefined"){delete e[n][h[m]];if(p&&h[m]===p){e[l]=null;f[a]=c}}else{e[n][h[m]]=d;if(p&&h[m]===p)f[a]=d}}else if(typeof d==="undefined"){p&&delete e[n][p];e[l]=null;f[a]=c}else{if(p)e[n][p]=d;f[a]=d}return this};Collection.prototype._reset=function(a,
...
b):b:this._get("collection");if(b===null)return 0;if(g.isString(b))return b.length;if((a===true||!a)&&!this._getActiveParam("filter")&&typeof b.length!=="undefined")l=b.length;else{l=0;this.forEach(function(){l+=1},a,b,c,d||"",f||"",e||"",i||"",k||"")}return l};Collection.prototype.forEach=function(a,b,c,d,f,e,i,k,l){a=this._isStringExpression(a)?this._compileFunc(a):a;b=g.isString(b=b||"")?b.split(this.SHORT_SPLITTER):b;c=c||"";d=d===false?false:true;f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||
false;i=parseInt(i)||false;k=parseInt(k)||false;l=l||false;var n=this,p={},h=[],m="",r,s,j,q,o=0,t=0,u=false;if(g.isArray(b))if(b[1]){m=b[0].trim();b=b[1].trim()}else b=b[0].trim();r=!g.isCollection(c)?this._getOne(m,c):c;if(typeof r!=="object")throw Error("incorrect data type!");s=function(){if(!s.val)s.val=n.length(b,c);return s.val};j=function(w,z){if(!j.val)j.val=n.length(w||"",z||"");return j.val};if(g.isArray(r)){h=i!==false&&!l?r.slice(i):r;if(l)for(q=h.length-i;(q-=1)>-1;){if(k&&q===k)break;
if(f!==false&&t===f)break;if(this._customFilter(b,h[q],q,r,o,j,this,c,p)===true)if(e!==false&&e!==0)e-=1;else{u=a.call(a,h[q],q,r,o,s,this,c)===false;if(d===false)u=true;t+=1}o+=1;if(u===true)break}else h.some(function(w,z){z+=i;if(k&&z===k)return true;if(f!==false&&t===f)return true;if(this._customFilter(b,w,z,r,o,j,this,c,p)===true)if(e!==false&&e!==0)e-=1;else{u=a.call(a,w,z,r,o,s,this,c)===false;if(d===false)u=true;t+=1}o+=1;if(u===true)return true},this)}else if(l){for(q in r)r.hasOwnProperty(q)&&
h.push(q);for(q=h.length-i;(q-=1)>-1;){if(k&&q===k)break;if(f!==false&&t===f)break;if(this._customFilter(b,r[h[q]],h[q],r,o,j,this,c,p)===true)if(e!==false&&e!==0)e-=1;else{u=a.call(a,r[h[q]],h[q],r,o,s,this,c)===false;if(d===false)u=true;t+=1}o+=1;if(u===true)break}}else for(q in r)if(r.hasOwnProperty(q)){if(k&&o===k)break;if(f!==false&&t===f)break;if(i!==false&&i!==0)i-=1;else{if(this._customFilter(b,r[q],q,r,o,j,this,c,p)===true)if(e!==false&&e!==0)e-=1;else{u=a.call(a,r[q],q,r,o,s,this,c)===false;
if(d===false)u=true;t+=1}o+=1;if(u===true)break}}p.name&&this._drop("filter","__tmp:"+p.name);j=s=null;return this};Collection.prototype.some=function(a,b,c,d,f,e,i){return this.forEach(a,b||"",c||"",false,"",d||"",f||"",e||"",i||"")};Collection.prototype.search=function(a,b,c){b=this._splitId(b);c=c===false?false:true;var d=c===true?[]:-1,f=b.to,e=b.set,i=g.toArray(arguments);b=i[1]=b.id;i.unshift(c===true?function(k,l){d.push(l)}:function(k,l){d=l});this.forEach.apply(this,i);if(f)return this._saveResult(f,
...
function(a,b,c,d,f){a=a||"";if(g.isNumber(b)||g.isString(b)&&!this._isFilter(b)||arguments.length<2||b===false)return this._removeOne("eq(0)",a);return this.removeOne(b||"",a,c||"",d||"",f||"")};Collection.prototype.group=function(a,b,c,d,f,e,i,k,l,n){a=this._isStringExpression(a=a||"")?this._compileFilter(a):a;c=this._splitId(c);n=n||false;var p=g.isString(a),h={},m=c.to,r=c.set,s=g.toArray(arguments);c=s[2]=c.id;s.unshift(p?n?function(j,q){var o=g.byLink(j,a);if(h[o])h[o].push(q);else h[o]=[q]}:
function(j){var q=g.byLink(j,a);if(h[q])h[q].push(j);else h[q]=[j]}:n?function(j,q){var o=a.apply(a,arguments);if(h[o])h[o].push(q);else h[o]=[q]}:function(j){var q=a.apply(a,arguments);if(h[q])h[q].push(j);else h[q]=[j]});s.splice(1,1);this.forEach.apply(this,s);if(m)return this._saveResult(m,r,h);return h};Collection.prototype.groupLinks=function(){var a=Collection.unshift(arguments,action);a.push(true);return this.group.apply(this,a)};Collection.prototype.stat=function(a,b,c,d,f,e,i,k,l){a=(a=
a||"count")&&this._isStringExpression(a)?this._compileFilter(a):a;b=(b=b||"")&&this._isStringExpression(b)?this._compileFilter(b):b;d=this._splitId(d);f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;i=parseInt(i)||false;k=parseInt(k)||false;l=l||false;var n=g.isString(a),p=g.isString(b),h=0,m=0,r=d.to,s=d.set;d=d.id;switch(a){case "count":n=function(){h+=1};break;case "summ":n=p?function(j){j=g.byLink(j,b);h+=j;return true}:function(){var j=b.apply(this,arguments);h+=j;return true};break;
case "avg":n=p?function(j){j=g.byLink(j,b);m+=1;h+=j;return true}:function(){var j=b.apply(this,arguments);m+=1;h+=j;return true};break;case "max":n=p?function(j){j=g.byLink(j,b);if(j>h)h=j;return true}:function(){var j=b.apply(this,arguments);if(j>h)h=j;return true};break;case "min":n=p?function(j){j=g.byLink(j,b);if(m===0){h=j;m=1}else if(j<h)h=j;return true}:function(){var j=b.apply(this,arguments);if(m===0){h=j;m=1}else if(j<h)h=j;return true};break;default:n=n?p?function(j){j=g.byLink(j,b);if(m===
0){h=j;m=1}else h=g.expr(a+"="+j,h);return true}:function(){var j=b.apply(this,arguments);if(m===0){h=j;m=1}else h=g.expr(a+"="+j,h);return true}:p?function(j){j=g.byLink(j,b);h=a(j,h);return true}:function(){var j=b.apply(this,arguments);h=a(j,h);return true}}if(a!=="first"&&a!=="last"){this.forEach(n,c||"",d,"",f,e,i,k,l);if(a==="avg")h/=m}else h=a==="first"?this._getOne(g.ORDER[0]+"0"+g.ORDER[1]):this._getOne(g.ORDER[0]+"-1"+g.ORDER[1]);if(r)return this._saveResult(r,s,h);return h};Collection.prototype.groupStat=
function(a,b,c,d,f,e,i,k,l){a=(a=a||"count")&&this._isStringExpression(a)?this._compileFilter(a):a;b=(b=b||"")&&this._isStringExpression(b)?this._compileFilter(b):b;d=this._splitId(d);f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;i=parseInt(i)||false;k=parseInt(k)||false;l=l||false;var n=g.isString(a),p=g.isString(b),h={},m={},r=d.to,s=d.set,j,q;d=d.id;switch(a){case "count":q=function(){h[this.key]+=1};break;case "summ":q=p?function(o){o=g.byLink(o,b);h[this.key]+=o;return true}:function(){var o=
