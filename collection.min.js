...
c.collection=a};Collection.byLink=function(a,b,c,d){b=b.toString().replace(RegExp("\\s*"+Collection.CHILDREN+"\\s*","g"),Collection.CONTEXT_SEPARATOR+Collection.CHILDREN+Collection.CONTEXT_SEPARATOR).split(Collection.CONTEXT_SEPARATOR);d=d||false;for(var f=a,e=Collection.CHILDREN,i=0,h=0,g,j=b.length,n,m;(j-=1)>-1;){b[j]=Collection.trim(b[j]);if(b[j]===""){b.splice(j,1);i-=1}else if(b[j]!==Collection.CHILDREN){if(j>i)i=j;h+=1}}m=b.length;if(a===false)return b.join("");else if(Collection.isNumber(a)){if((a=
+a)<0)a+=h;if(typeof c==="undefined"){j=-1;for(n=0;(j+=1)<m;)if(b[j]!==Collection.CHILDREN)if((n+=1)===a){b.splice(j+1,m);return b.join("")}}else{j=m;for(n=0;(j-=1)>-1;)if(b[j]!==Collection.CHILDREN)if((n+=1)===a){b.splice(0,j);return b.join("")}}}for(j=-1;(j+=1)<m;)switch(b[j]){case Collection.CHILDREN:e=b[j];break;default:if(e===Collection.CHILDREN&&b[j].substring(0,Collection.ORDER[0].length)!==Collection.ORDER[0])if(j===i&&typeof c!=="undefined")if(d===false)a[b[j]]=Collection.expr(c,a[b[j]]);
else if(Collection.isArray(a))a.splice(b[j],1);else delete a[b[j]];else a=a[b[j]];else{h=b[j].substring(Collection.ORDER[0].length);h=h.substring(0,h.length-1);h=+h;if(Collection.isArray(a))if(j===i&&typeof c!=="undefined")if(h>=0)if(d===false)a[h]=Collection.expr(c,a[h]);else a.splice(h,1);else if(d===false)a[a.length+h]=Collection.expr(c,a[a.length+h]);else a.splice(a.length+h,1);else a=h>=0?a[h]:a[a.length+h];else{if(h<0){n=0;for(g in a)if(a.hasOwnProperty(g))n+=1;h+=n}n=0;for(g in a)if(a.hasOwnProperty(g)){if(h===
n){if(j===i&&typeof c!=="undefined")if(d===false)a[g]=Collection.expr(c,a[g]);else delete a[g];else a=a[g];break}n+=1}}}}if(typeof c!=="undefined")return f;return a};Collection.execEvent=function(a,b,c,d){a=a.split(Collection.QUERY_SEPARATOR);c=Collection.isExists(c)?c:[];c=Collection.isArray(c)?c:[c];for(var f=-1,e=a.length-1;(f+=1)<e;)b=b[a[f]];d=d||b;if(a[f].search(Collection.SUBQUERY_SEPARATOR)!==-1){a=a[f].split(Collection.SUBQUERY_SEPARATOR);b=b[a[0]];a.splice(0,1);c=c.concat(a);return b.apply(d,
...
d=Collection.drivers.dom;Array.prototype.forEach.call(a,function(f){if(f.nodeType===1){var e=d.data(f),i=f.hasAttribute("class")?f.getAttribute("class").split(" "):"",h=d.text(f),g,j=b.length;b.push({});for(g in e)if(e.hasOwnProperty(g))b[j][g]=e[g];if(i){b[j][c.classes]={};i.forEach(function(n){b[j][c.classes][n]=n})}if(f.childNodes.length!==0)b[j][c.childNodes]=Collection._inObj(f.childNodes);if(h!==false)b[j][c.val]=h.replace(/[\r\t\n]/g," ")}});return b};Collection.fromNode=function(a,b){if(typeof JSON===
...
1,e.length)}return this};Collection.prototype._backIf=function(a){if(this.dObj.sys[a+"ChangeControl"]===true)return this._back.apply(this,arguments);return this};Collection.prototype._drop=function(a,b,c,d){c=typeof c==="undefined"?false:c;var f=this.dObj.active,e=this.dObj.sys,i=Collection.toUpperCase(a,1),h,g="active"+i+"ID",j="tmp"+i,n=this._getActiveID(a),m=!b?n?[n]:[]:Collection.isArray(b)||Collection.isPlainObject(b)?b:[b],l;if(typeof d==="undefined")this["onDrop"+i]&&(h=this["onDrop"+i](b,
c));else this["onReset"+i]&&(h=this["onReset"+i](b,d));if(h===false)return this;if(m[0]&&m[0]!==this.ACTIVE)for(l in m){if(m.hasOwnProperty(l))if(!m[l]||m[l]===this.ACTIVE)if(typeof d==="undefined"){n&&delete e[j][n];e[g]=null;f[a]=c}else{if(n)e[j][n]=d;f[a]=d}else if(typeof d==="undefined"){delete e[j][m[l]];if(n&&m[l]===n){e[g]=null;f[a]=c}}else{e[j][m[l]]=d;if(n&&m[l]===n)f[a]=d}}else if(typeof d==="undefined"){n&&delete e[j][n];e[g]=null;f[a]=c}else{if(n)e[j][n]=d;f[a]=d}return this};Collection.prototype._reset=
...
c),this._getActiveParam("context")+Collection.CHILDREN+b);if(typeof d!=="object")throw Error("incorrect data type!");if(Collection.isPlainObject(d))Collection.extend(true,d,a);else if(Collection.isArray(d))if(Collection.isArray(a)){d=Array.prototype.concat(d,a);this._setOne(b,d,c)}else this.add(a,"push",c);return this};Collection.prototype.length=function(a,b,c,d,f,e,i,h){a=a||"";c=c===false?false:true;var g,j;if(!Collection.isFunction(a))if(Collection.isString(a)&&!this._isFilter(a)&&!Collection.isExists(b)||
Collection.isCollection(a)){b=a;a=false}if(b)if(Collection.isString(b))b=this._get("collection",b);else g=true;else b=this._get("collection");if(b===null)return 0;if(g!==true)b=Collection.byLink(b,this._getActiveParam("context"));if(Collection.isString(b))return b.length;if((a===true||!a)&&!this._getActiveParam("filter")&&typeof b.length!=="undefined")j=b.length;else{j=0;this.forEach(function(){j+=1},a,b,c,d||"",f||"",e||"",i||"",h||"")}return j};Collection.prototype.forEach=function(a,b,c,d,f,e,
i,h,g){a=this._isStringExpression(a)?this._compileFunc(a):a;b=b||"";c=c||"";d=d===false?false:true;f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;i=parseInt(i)||false;h=parseInt(h)||false;g=g||false;var j=this,n={},m=[],l,o,p,k,q=0,r=0,s=false;l=!Collection.isCollection(c)?Collection.byLink(this._get("collection",c),this._getActiveParam("context")):c;if(typeof l!=="object")throw Error("incorrect data type!");o=function(){if(!o.val)o.val=j.length(b,c);return o.val};p=function(u,t){if(!p.val)p.val=
j.length(u||"",t||"");return p.val};if(Collection.isArray(l)){m=i!==false&&!g?l.slice(i):l;if(g)for(k=m.length-i;(k-=1)>-1;){if(h&&k===h)break;if(f!==false&&r===f)break;if(this._customFilter(b,m[k],k,l,q,p,this,c,n)===true)if(e!==false&&e!==0)e-=1;else{s=a.call(a,m[k],k,l,q,o,this,c)===false;if(d===false)s=true;r+=1}q+=1;if(s===true)break}else m.some(function(u,t){t+=i;if(h&&t===h)return true;if(f!==false&&r===f)return true;if(this._customFilter(b,u,t,l,q,p,this,c,n)===true)if(e!==false&&e!==0)e-=
1;else{s=a.call(a,u,t,l,q,o,this,c)===false;if(d===false)s=true;r+=1}q+=1;if(s===true)return true},this)}else if(g){for(k in l)l.hasOwnProperty(k)&&m.push(k);for(k=m.length-i;(k-=1)>-1;){if(h&&k===h)break;if(f!==false&&r===f)break;if(this._customFilter(b,l[m[k]],m[k],l,q,p,this,c,n)===true)if(e!==false&&e!==0)e-=1;else{s=a.call(a,l[m[k]],m[k],l,q,o,this,c)===false;if(d===false)s=true;r+=1}q+=1;if(s===true)break}}else for(k in l)if(l.hasOwnProperty(k)){if(h&&q===h)break;if(f!==false&&r===f)break;if(i!==
false&&i!==0)i-=1;else{if(this._customFilter(b,l[k],k,l,q,p,this,c,n)===true)if(e!==false&&e!==0)e-=1;else{s=a.call(a,l[k],k,l,q,o,this,c)===false;if(d===false)s=true;r+=1}q+=1;if(s===true)break}}n.name&&this._drop("filter","__tmp:"+n.name);p=o=null;return this};Collection.prototype.some=function(a,b,c,d,f,e,i){return this.forEach(a,b||"",c||"",false,"",d||"",f||"",e||"",i||"")};Collection.prototype.search=function(a,b,c){c=c===false?false:true;var d=c===true?[]:-1;this.forEach.apply(this,Collection.unshiftArguments(arguments,
function(f,e){if(c===true)d.push(e);else d=e;return true}));return d};Collection.prototype.searchOne=function(a,b,c,d,f,e){return this.search(a||"",b||"",false,"",c||"",d||"",f||"",e||"")};Collection.prototype.indexOf=function(a,b,c){c=c||"";b=b||"";Collection.byLink(this._get("collection",c),this._getActiveParam("context"));return this.searchOne(function(d){return d===a},c,"",b)};Collection.prototype.lastIndexOf=function(a,b,c){c=c||"";b=b||"";Collection.byLink(this._get("collection",c),this._getActiveParam("context"));
return this.searchOne(function(d){return d===a},c,"",b,"",true)};Collection.prototype.get=function(a,b,c){if(Collection.isNumber(a)||Collection.isString(a)&&!this._isFilter(a)||arguments.length===0||a===false)return this._getOne(a,b||"");c=c===false?false:true;var d=c===true?[]:-1;this.forEach.apply(this,Collection.unshiftArguments(arguments,function(f,e,i){if(c===true)d.push(i[e]);else d=i[e];return true}));return d};Collection.prototype.getOne=function(a,b,c,d,f,e){return this.get(a||"",b||"",false,
"",c||"",d||"",f||"",e||"")};Collection.prototype.set=function(a,b,c){if(Collection.isNumber(a)||Collection.isString(a)&&!this._isFilter(a)||arguments.length===0||a===false)return this._setOne(a,b,c||"");b=this._isStringExpression(b)?this._compileFunc(b):b;var d,f,e,i=Collection.isFunction(b);f=Collection.unshiftArguments(arguments,function(h,g,j){if(i){e=b.apply(b,arguments);if(typeof e!=="undefined")j[g]=e}else j[g]=Collection.expr(b,j[g]);return true});f.splice(2,1);this.onSet&&(d=this.onSet.apply(this,
arguments));if(d===false)return this;return this.forEach.apply(this,f)};Collection.prototype.setOne=function(a,b,c,d,f,e,i){return this.set(a||"",b,c||"",false,"",d||"",f||"",e||"",i||"")};Collection.prototype.map=function(a){a=this._isStringExpression(a)?this._compileFilter(a):a;var b,c,d=Collection.isExists(a),f=Collection.isFunction(a),e=null;b=Collection.unshiftArguments(arguments,function(i,h,g){if(e===null)c=(e=Collection.isArray(g))?[]:{};if(f)if(e)c.push(a.apply(a,arguments));else c[h]=a.apply(a,
arguments);else if(d)if(e)c.push(Collection.expr(a,g[h]));else c[h]=Collection.expr(a,g[h]);else if(e)c.push(g[h]);else c[h]=g[h];return true});b.splice(1,1);this.forEach.apply(this,b);return c};Collection.prototype.move=function(a,b,c,d,f,e,i,h,g,j,n,m){a=a||"";b=Collection.isExists(b)?b.toString():"";c=c||"";d=d||"";f=f||"push";e=e===false?false:true;m=m===false?false:true;var l=[],o=Collection.isArray(Collection.byLink(this._get("collection",d),this._getActiveParam("context"))),p;p=null;m&&this.onMove&&
(p=this.onMove.apply(this,arguments));!m&&this.onCopy&&(p=this.onCopy.apply(this,arguments));if(p===false)return this;this.disable("context");p=Collection.isNumber(a)||Collection.isString(a)&&!this._isFilter(a)||arguments.length===0||a===false?a:this.search(a,c,e,i||"",h||"",g||"",j||"",n||"");this.enable("context");console.log(p);if(e===true&&Collection.isArray(p))p.forEach(function(k){this.add(b+Collection.CHILDREN+k,o===true?f:k+Collection.METHOD_SEPARATOR+f,d,c);m===true&&l.push(k)},this);else{this.add(b+
Collection.CHILDREN+p,o===true?f:p+Collection.METHOD_SEPARATOR+f,d,c);m===true&&l.push(p)}if(m===true){this.disable("context");n===true?l.forEach(function(k){this._removeOne(k,c)},this):this._remove(l,c);this.enable("context")}return this};Collection.prototype.moveOne=function(a,b,c,d,f,e,i,h,g){return this.move(a||"",Collection.isExists(b)?b.toString():"",c||"",d||"",f||"",false,"",e||"",i||"",h||"",g||"")};Collection.prototype.copy=function(a,b,c,d,f,e,i,h,g){return this.move(a||"",Collection.isExists(b)?
...
b||"");var g=this.search.apply(this,arguments);if(Collection.isArray(g))h===true?g.forEach(function(j){this._removeOne(j,b)},this):this._remove(g,b);else this._removeOne(g,b);return this};Collection.prototype.removeOne=function(a,b,c,d,f,e){return this.remove(a||"",b||"",false,"",c||"",d||"",f||"",e||"")};Collection.prototype.pop=function(a,b,c,d,f){a=a||"";if(Collection.isNumber(b)||Collection.isString(b)&&!this._isFilter(b)||arguments.length<2||b===false)return this._removeOne("eq(-1)",a);return this.removeOne(b||
"",a,c||"",d||"",f||"",true)};Collection.prototype.shift=function(a,b,c,d,f){a=a||"";if(Collection.isNumber(b)||Collection.isString(b)&&!this._isFilter(b)||arguments.length<2||b===false)return this._removeOne("eq(0)",a);return this.removeOne(b||"",a,c||"",d||"",f||"")};Collection.prototype.group=function(a,b,c,d,f,e,i,h,g,j){a=this._isStringExpression(a=a||"")?this._compileFilter(a):a;j=j||false;var n=Collection.isString(a),m={},l;l=Collection.unshiftArguments(arguments,function(o,p){var k=n?Collection.byLink(o,
a):a.apply(a,arguments);if(m[k])m[k].push(!j?o:p);else m[k]=[!j?o:p];return true});l.splice(1,1);this.forEach.apply(this,l);return m};Collection.prototype.groupLinks=function(){var a=Collection.unshiftArguments(arguments,action);a.push(true);return this.group.apply(this,a)};Collection.prototype.stat=function(a,b,c,d,f,e,i){a=(a=a||"count")&&this._isStringExpression(a)?this._compileFilter(a):a;b=(b=b||"")&&this._isStringExpression(b)?this._compileFilter(b):b;d=d||"";f=parseInt(f)>=0?parseInt(f):false;
e=parseInt(e)||false;i=parseInt(i)||false;var h=Collection.isString(a),g=0,j=0,n=function(m,l,o,p,k,q,r){m=Collection.isString(b)?Collection.byLink(m,b):b(m,l,o,p,k,q,r);switch(a){case "count":g+=1;break;case "summ":g+=m;break;case "avg":j+=1;g+=m;break;case "max":if(m>g)g=m;break;case "min":if(j===0){g=m;j=1}else if(m<g)g=m;break;default:if(h)if(j===0){g=m;j=1}else g=Collection.expr(a+"="+m,g);else g=a(m,g)}return true};if(a!=="first"&&a!=="last"){this.forEach(n,c||"",d,"",f,e,i);if(a==="avg")g/=
j}else g=a==="first"?this._getOne(Collection.ORDER[0]+"0"+Collection.ORDER[1]):this._getOne(Collection.ORDER[0]+"-1"+Collection.ORDER[1]);return g};Collection.prototype.groupStat=function(a,b,c,d,f,e,i){a=(a=a||"count")&&this._isStringExpression(a)?this._compileFilter(a):a;b=(b=b||"")&&this._isStringExpression(b)?this._compileFilter(b):b;d=d||"";f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;i=parseInt(i)||false;var h=Collection.isString(a),g={},j={},n,m=function(l,o,p,k,q,r,s){l=Collection.isString(b)?
Collection.byLink(l,b):b(l,o,p,k,q,r,s);switch(a){case "count":g[this.key]+=1;break;case "summ":g[this.key]+=l;break;case "avg":j[this.key]+=1;g[this.key]+=l;break;case "max":if(l>g[this.key])g[this.key]=l;break;case "min":if(j[this.key]===0){g[this.key]=l;j[this.key]=1}else if(l<g[this.key])g[this.key]=l;break;default:if(h)if(j[this.key]===0){g[this.key]=l;j[this.key]=1}else g[this.key]=Collection.expr(a+"="+l,g[this.key]);else g[this.key]=a(l,g[this.key])}return true};this.forEach(function(l,o,
p,k,q,r,s){g[o]||(g[o]=j[o]=0);if(a!=="first"&&a!=="last")r._update("context","+="+Collection.CHILDREN+(m.key=o)).forEach(m,c||"",s,"",f,e,i).parent();else g[o]=a==="first"?Collection.byLink(l,Collection.ORDER[0]+"0"+Collection.ORDER[1]):Collection.byLink(l,Collection.ORDER[0]+"-1"+Collection.ORDER[1]);return true},"",d);if(a==="avg")for(n in g)if(g.hasOwnProperty(n))g[n]/=j[n];return g};Collection._sortObject=function(a,b,c){b=[];var d={},f;for(f in a)a.hasOwnProperty(f)&&b.push({key:f,value:a[f]});
...
return(a=this._get("filter","__tmp:"+a)).call(a,b,c,d,f,e,i,h)}a=Collection.trim(a.toString().replace(/\s*(\(|\))\s*/g," $1 ").replace(/\s*(\|\||&&)\s*/g," $1 ").replace(/(!)\s*/g,"$1")).split(" ");for(k=a.length;(k-=1)>-1;)a[k]===""&&a.splice(k,1)}j=function(q,r){for(var s=-1,u=q.length,t=0,v=[];(s+=1)<u;){r+=1;if(q[s]==="("||q[s]==="!(")t+=1;if(q[s]===")")if(t===0)return{result:v,iter:r};else t-=1;v.push(q[s])}};g=a.length;for(k=-1;(k+=1)<g;)if(a[k]==="("||a[k]==="!("){if(a[k].substring(0,1)===
"!"){p=true;a[k]=a[k].substring(1)}else p=false;k=(m=j(a.slice(k+1),k)).iter;m=m.result.join(" ");m=this._customFilter(m,b,c,d,f,e,i,h);n=!l&&!o?p===true?!m:m:l?p===true?!m:m&&n:p===true?!m:m||n}else if(a[k]!==")"&&a[k]!=="||"&&a[k]!=="&&"){if(a[k].substring(0,1)==="!"){p=true;a[k]=a[k].substring(1)}else p=false;m=this._customFilter(this._get("filter",a[k]),b,c,d,f,e,i,h);n=!l&&!o?p===true?!m:m:l?p===true?!m:m&&n:p===true?!m:m||n}else if(a[k]==="||"){l=false;o=true}else if(a[k]==="&&"){o=false;l=
...
function(a,b,c){if(typeof JSON==="undefined"||!JSON.stringify)throw Error("object JSON is not defined!");b=b||"";c=c||"";if(a&&Collection.isCollection(a))return JSON.stringify(a,b,c);return JSON.stringify(Collection.byLink(this._get("collection",a||""),this._getActiveParam("context")),b,c)};Collection.prototype.valueOf=function(a){if(a==="object")return this;return this.length(this.ACTIVE)};Collection.prototype.print=function(a,b){b=b||false;var c=this,d={},f={},e={},i,h,g,j,n=0,m,l=null,o=false,
p,k="",q,r,s=this.drivers.dom;if(Collection.isExists(a)&&(Collection.isString(a)||Collection.isNumber(a)))a={page:a};else Collection.isExists(a)||(a={page:this._get("page")});Collection.extend(true,e,this.dObj.active,a);if(a)e.page=Collection.expr(e.page,this._get("page"));if(e.page<1)e.page=1;e.collection=Collection.isString(e.collection)?this._get("collection",e.collection):e.collection;e.template=Collection.isString(e.template)?this._get("template",e.template):e.template;e.cache=Collection.isExists(a.cache)?
a.cache:this._getActiveParam("cache");e.target=Collection.isString(e.target)?s.find(e.target):e.target;e.pager=Collection.isString(e.pager)?s.find(e.pager):e.pager;e.filter=this._isStringExpression(e.filter)?this._compileFilter(e.filter):e.filter;e.parser=this._isStringExpression(e.parser)?this._compileParser(e.parser):e.parser;e.callback=e.callback&&this._isStringExpression(e.callback)?this._compileFunc(e.callback):e.callback;if(b===true)e.cache.iteration=false;m=this._get("page")-e.page;this._update("page",
e.page);q=function(u,t){e.callback&&e.callback.apply(e.callback,arguments);k+=e.template.apply(e.template,arguments);n=t;if(o===false)o=t;return true};i=Collection.byLink(e.collection,this._getActiveParam("context")+Collection.CHILDREN+(a&&a.context||""));h=this.length(e.collection);g=function(u,t){if(!g.val)g.val=c.length(u,t);return g.val};p=Boolean(e.breaker&&(e.filter||this._getActiveParam("filter")));e.breaker=e.breaker||h;if(Collection.isPlainObject(i)||!e.cache||e.cache.iteration===false||
e.cache.firstIteration===false||e.cache.lastIteration===false){j=!e.breaker||e.page===1?0:(e.page-1)*e.breaker;this.forEach(q,e.filter,this.ACTIVE,true,e.breaker,j);if(e.cache&&e.cache.iteration===false)e.cache.lastIteration=false}else if(Collection.isArray(i)&&e.cache.iteration===true){j=!p?e.page===1?0:(e.page-1)*e.breaker:m>=0?e.cache.firstIteration:e.cache.lastIteration;if(p)if(m>0){for(m*=e.breaker;(j-=1)>-1;)if(this._customFilter(e.filter,i[j],i,j,g,this,this.ACTIVE,f)===true)if(n===m)break;
else n+=1;e.cache.lastIteration=j+=1;l=null}else if(m<0)l=-m*e.breaker-e.breaker;f.name&&this._drop("filter","__tmp:"+f.name);this.forEach(q,e.filter,this.ACTIVE,true,e.breaker,l,j)}if(e.cache){if(m!==0&&e.cache.iteration!==false){this._get("cache").firstIteration=o;this._get("cache").lastIteration=n+1}if(e.cache.autoIteration===true)this._get("cache").iteration=true}g=null;k=!k?e.resultNull:this._customParser(e.parser,k,d);d.name&&this._drop("parser","__tmp:"+d.name);if(e.target===false){e.variable?
this._push("variable",e.variable,k):this._new("variable",k);return this}else Array.prototype.forEach.call(e.target,function(u){if(e.toHTML==="replace")u.innerHTML=k;else if(e.toHTML==="append")u.innerHTML+=k;else u.innerHTML=k+u.innerHTML},this);if(!e.pager)return this;e.nmbOfEntries=e.filter!==false?this.length(e.filter,e.collection):h;e.nmbOfEntriesInPage=e.calculator?s.find(e.calculator,e.target[0]).length:s.children(e.target[0]).length;e.finNumber=e.breaker*e.page-(e.breaker-e.nmbOfEntriesInPage);
if(e.page!==1&&e.nmbOfEntriesInPage===0){this.onIPage&&(r=this.onIPage.apply(this,arguments));if(r===false)return this;this._update("page",e.page-=1).print(e,true,true)}else this.easyPage(e);return this};Collection.prototype.easyPage=function(a){var b=this,c="",d=a.nmbOfPages||(a.nmbOfEntries%a.breaker!==0?~~(a.nmbOfEntries/a.breaker)+1:a.nmbOfEntries/a.breaker),f=function(m,l,o,p){p=p||false;var k,q="<"+(m.tag||"span")+" "+(!p?'data-page="':'data-number-break="')+o+'"';if(m.attr)for(k in m.attr)if(m.attr.hasOwnProperty(k))q+=
" "+k+'="'+m.attr[k]+'"';if(!p&&o===a.page||p&&o===a.breaker)q+=' class="'+(l&&l.active||"active")+'"';return q+(">"+o+"</"+(m.tag||"span")+">")},e=function(m,l){if(l==="select")return'<option value="'+m+'">'+m+"</option>";return m},i,h=0,g,j,n=this.drivers.dom;Array.prototype.forEach.call(a.pager,function(m){Array.prototype.forEach.call(n.find(".ctm",m),function(l){if(a.navBreaker<=2)throw Error('parameter "navBreaker" must be more than 2');c="";var o=l.tagName.toLowerCase(),p=n.data(l),k=p.ctm,
q=k.classes;if(k.nav){if(["first","prev","next","last"].indexOf(k.nav)!==-1&&!p["ctm-delegated"]){n.bind(l,"click",function(){if(!n.hasClass(this,k.classes&&k.classes.disabled||"disabled")){k.nav==="first"&&(a.page=1);k.nav==="prev"&&(a.page="-=1");k.nav==="next"&&(a.page="+=1");k.nav==="last"&&(a.page=d);b.print(a)}});l.setAttribute("data-ctm-delegated",true)}if(["first","prev"].indexOf(k.nav)!==-1&&a.page===1||["next","last"].indexOf(k.nav)!==-1&&a.finNumber===a.nmbOfEntries)n.addClass(l,q&&q.disabled||
"disabled");else if(["first","prev","next","last"].indexOf(k.nav)!==-1)n.removeClass(l,q&&q.disabled||"disabled");k.nav==="numberSwitch"&&k.val.forEach(function(r){c+=o==="select"?'<option vale="'+r+'" '+(r===a.breaker?'selected="selected"':"")+">"+r+"</option>":f(k,q||"",r,true)});if(k.nav==="pageList")if(o==="select")for(i=0;(i+=1)<=d;)c+='<option vale="'+i+'" '+(i===a.page?'selected="selected"':"")+">"+i+"</option>";else if(d>a.navBreaker){h=a.navBreaker%2!==0?1:0;j=g=(a.navBreaker-h)/2;if(a.page-
h<g)g=0;else{g=a.page-g-h;if(a.page+j>d)g-=a.page+j-d}i=g;for(h=-1;(i+=1)<=d&&(h+=1)!==null;){if(h===a.navBreaker&&i!==a.page)break;c+=f(k,q||"",i)}}else for(i=0;(i+=1)<=d;)c+=f(k,q||"",i);if(k.nav==="numberSwitch"||k.nav==="pageList"){l.innerHTML=c;if(!p["ctm-delegated"]){o!=="select"?n.bind(l,"click",function(r){r=r||window.event;r=r.target||r.srcElement;var s=n.data(r);if(r.parentNode!==l)return false;if(k.nav==="pageList")a.page=+s.page;else{b._push("breaker",a.name||"",+s["number-break"]);delete a.breaker}b.print(a)}):
n.bind(l,"change",function(){var r=n.children(this,"selected")[0];if(a.page!==r.value){if(p.nav==="pageList")a.page=+r.value;else{b._push("breaker",a.name||"",+r.value);delete a.breaker}b.print(a)}});l.setAttribute("data-ctm-delegated",true)}}}else if(k.info){a.nmbOfEntriesInPage===0?n.addClass(l,q&&q.noData||"no-data"):n.removeClass(l,q&&q.noData||"no-data");switch(k.info){case "page":if(o==="input")l.value=e(a.page,o);else l.innerHTML=e(a.page,o);break;case "total":if(o==="input")l.value=e(a.nmbOfEntries,
