...
(p=this.onMove.apply(this,arguments));!m&&this.onCopy&&(p=this.onCopy.apply(this,arguments));if(p===false)return this;this.disable("context");p=Collection.isNumber(a)||Collection.isString(a)&&!this._isFilter(a)||arguments.length===0||a===false?a:this.search(a,c,e,i||"",h||"",g||"",j||"",n||"");this.enable("context");if(e===true&&Collection.isArray(p))p.forEach(function(k){this.add(b+Collection.CHILDREN+k,o===true?f:k+Collection.METHOD_SEPARATOR+f,d,c);m===true&&l.push(k)},this);else{this.add(b+Collection.CHILDREN+
p,o===true?f:p+Collection.METHOD_SEPARATOR+f,d,c);m===true&&l.push(p)}if(m===true){this.disable("context");n===true?l.forEach(function(k){this._removeOne(k,c)},this):this._remove(l,c);this.enable("context")}return this};Collection.prototype.moveOne=function(a,b,c,d,f,e,i,h,g){return this.move(a||"",Collection.isExists(b)?b.toString():"",c||"",d||"",f||"",false,"",e||"",i||"",h||"",g||"")};Collection.prototype.copy=function(a,b,c,d,f,e,i,h,g){return this.move(a||"",Collection.isExists(b)?b.toString():
