...
return a.substring(c,b).toUpperCase()+a.substring(b)};e.toLowerCase=function(a,b,c){c=c||0;if(!b)return a.toLowerCase();return a.substring(c,b).toLowerCase()+a.substring(b)};e.Collection.storage={dObj:{active:{collection:null,filter:false,context:"",cache:{autoIteration:false,iteration:false,firstIteration:false,lastIteration:false},index:null,map:null,variable:null,defer:"",page:1,parser:false,appendType:"html",target:null,calculator:".line",pager:"#pageControl",template:null,numberBreak:10,pageBreak:10,
resultNull:""}}};e.Collection.storage.dObj.sys={flags:{use:{context:true,filter:true,parser:true}}};(function(a){var b,c,d=e.Collection.storage.dObj.sys;for(b=a.length;b--;){c=e.toUpperCase(a[b],1);d["active"+c+"ID"]=null;d["tmp"+c]={};d[a[b]+"ChangeControl"]=null;d[a[b]+"Back"]=[]}})(e.Collection.fn.stack);e.Collection.fn._$=function(a,b){var c=this.dObj,d=c.active,g=e.toUpperCase(a,1);d[a]=nimble.expr(b,d[a]||"");c.sys["active"+g+"ID"]=null;return this};e.Collection.fn._update=function(a,b){var c=
this.dObj,d=c.active;c=c.sys;var g=e.toUpperCase(a,1),f=c["active"+g+"ID"];d[a]=nimble.expr(b,d[a]||"");if(f)c["tmp"+g][f]=d[a];return this};e.Collection.fn._get=function(a,b){var c=this.dObj;if(b&&b!==this.ACTIVE)return c.sys["tmp"+e.toUpperCase(a,1)][b];return c.active[a]};e.Collection.fn._push=function(a,b,c){var d=this.dObj.sys,g=e.toUpperCase(a,1),f=d["tmp"+g];d=d["active"+g+"ID"];var h;if(e.isPlainObject(b))for(h in b){if(b.hasOwnProperty(h))if(h===this.ACTIVE)throw Error("invalid property name!");
else if(f[h]&&d&&d===h)this._update(a,b[h]);else f[h]=b[h]}else if(b===this.ACTIVE)throw Error("invalid property name!");else if(f[b]&&d&&d===b)this._update(a,c);else f[b]=c;return this};e.Collection.fn._set=function(a,b){var c=this.dObj,d=c.sys,g=e.toUpperCase(a,1),f=a+"ChangeControl",h="active"+g+"ID";if(d[h]!==b){d[f]=true;d[h]=b}else d[f]=false;d[a+"Back"].push(b);c.active[a]=d["tmp"+g][b];return this};e.Collection.fn._back=function(a,b){var c=this.dObj,d=c.sys,g=e.toUpperCase(a,1),f=d[a+"Back"],
h;d[a+"ChangeControl"]=false;h=f.length-(b||1)-1;if(h>=0&&f[h])if(d["tmp"+g][f[h]]){d["active"+g+"ID"]=f[h];c.active[a]=d["tmp"+g][f[h]];f.splice(h+1,f.length)}return this};e.Collection.fn._backIf=function(a){if(this.dObj.sys[a+"ChangeControl"]===true)return this._back.apply(this,arguments);return this};e.Collection.fn._drop=function(a,b,c,d){c=c===undefined?false:c;var g=this.dObj,f=g.active;g=g.sys;var h=e.toUpperCase(a,1),j="active"+h+"ID";h="tmp"+h;var k=g[j];b=!b?k?[k]:[]:e.isArray(b)||e.isPlainObject(b)?
b:[b];var m;if(b[0]&&b[0]!==this.ACTIVE)for(m in b){if(b.hasOwnProperty(m))if(!b[m]||b[m]===this.ACTIVE)if(d===undefined){k&&delete g[h][k];g[j]=null;f[a]=c}else{if(k)g[h][k]=d;f[a]=d}else if(d===undefined){delete g[h][b[m]];if(k&&b[m]===k){g[j]=null;f[a]=c}}else{g[h][b[m]]=d;if(k&&b[m]===k)f[a]=d}}else if(d===undefined){k&&delete g[h][k];g[j]=null;f[a]=c}else{if(k)g[h][k]=d;f[a]=d}return this};e.Collection.fn._reset=function(a,b,c){return this._drop(a,b||"","",c===undefined?false:c)};e.Collection.fn._resetTo=
function(a,b,c){var d=this.dObj;c=!c||c===this.ACTIVE?d.active[a]:d.sys["tmp"+e.toUpperCase(a,1)][c];return this._reset(a,b||"",c)};e.Collection.fn._exist=function(a,b){var c=this.dObj,d=e.toUpperCase(a,1);if((!b||b===this.ACTIVE)&&c.sys["active"+d+"ID"])return true;if(c.sys["tmp"+d][b]!==undefined)return true;return false};e.Collection.fn._is=function(a,b){if(b===this.dObj.sys["active"+e.toUpperCase(a,1)+"ID"])return true;return false};e.Collection.fn.use=function(a){for(var b=this.stack.length;b--;)this._exist(this.stack[b],
a)&&this._set(this.stack[b],a);return this};e.Collection.fn._prop=function(a,b,c){var d=this.dObj[a];if(arguments.length!==3)if(e.isPlainObject(b))e.extend(d,b);else return d[b];else d[b]=c;return this};e.Collection.fn.active=function(){return this._prop.apply(this,e.unshiftArguments(arguments,"active"))};(function(a){var b,c=e.Collection.fn,d;for(b=a.length;b--;){d=e.toUpperCase(a[b],1);c["$"+d]=function(g){return function(f){return this._$(g,f)}}(a[b]);c["update"+d]=function(g){return function(f){return this._update(g,
f)}}(a[b]);c["reset"+d+"To"]=function(g){return function(f,h){return this._resetTo(g,f,h)}}(a[b]);c["push"+d]=function(g){return function(){return this._push.apply(this,e.unshiftArguments(arguments,g))}}(a[b]);c["set"+d]=function(g){return function(f){return this._set(g,f)}}(a[b]);c["pushSet"+d]=function(g){return function(f,h){return this._push(g,f,h)._set(g,f)}}(a[b]);c["back"+d]=function(g){return function(f){return this._back(g,f||"")}}(a[b]);c["back"+d+"If"]=function(g){return function(f){return this._backIf(g,
...
m):m;d.target[d.appendType](m);e.extend(true,d,{nmbOfEntries:this.length(d.filter),nmbOfEntriesInPage:e(d.calculator,d.target).length});d.finNumber=d.numberBreak*d.page-(d.numberBreak-d.nmbOfEntriesInPage);if(d.page!==1&&d.nmbOfEntriesInPage===0){d.page="-=1";this.extPrint(d)}else this.easyPage(d);return this};e.Collection.fn.easyPage=function(a){var b=this.dObj,c=b.viewVal;b=b.css;var d=a.nmbOfEntries%a.numberBreak!==0?~~(a.nmbOfEntries/a.numberBreak)+1:a.nmbOfEntries/a.numberBreak,g="",f,h=0;if(d>
a.pageBreak){g+=a.page!==1?'<a href="javascript:;" class="'+b.prev+'" data-page="1">'+c.prev+"</a>":'<a href="javascript:;" class="'+b.prev+" "+b.disabled+'" data-page="1">'+c.prev+"</a>";for(f=a.page-1;f++<d;)h++;f=h<a.pageBreak?a.pageBreak-h+1:1;h=0;for(f=a.page-f;f++<d;h++){if(h===a.pageBreak-1&&f!==a.page)break;if(f===a.page){if(h===0&&a.page!==1)g+='<a href="javascript:;" data-page="'+(f-1)+'">'+(f-1)+"</a>";else h--;g+='<a href="javascript:;" class="'+b.active+'" data-page="'+f+'">'+f+"</a>"}else g+=
'<a href="javascript:;" data-page="'+f+'">'+f+"</a>"}g+=f!==d+1?'<a href="javascript:;" data-page="'+d+'">'+c.next+"</a>":'<a href="javascript:;" class="'+b.next+" "+b.disabled+'" data-page="'+d+'">'+c.next+"</a>"}else for(f=0;f++<d;)g+=f===a.page?'<a href="javascript:;" class="'+b.active+'" data-page="'+f+'">'+f+"</a>":'<a href="javascript:;" data-page="'+f+'">'+f+"</a>";if(a.nmbOfEntries===0)e("."+b.nav+",."+b.info,a.pager).empty();else{e("."+b.nav,a.pager).html(g);e("."+b.info,a.pager).text(c.total+
": "+a.nmbOfEntries+". "+c.show+": "+((a.page-1)*a.numberBreak+1)+"-"+a.finNumber)}return this};e.Collection.fn.genTable=function(a,b,c){a=a||4;b=b||"td";c=c===false?false:true;var d=1,g,f=this.dObj.active.target,h=f.find(b).length,j="";f.find(b).each(function(k){this.tagName!=="td"&&e(this).wrap("<td></td>");if(d===a){j="";for(g=-1;++g<a;){j+="td:eq("+(k-g)+")";if(g!==a-1)j+=","}f.find(j).wrapAll("<tr></tr>");d=0}else if(k===h-1&&d!==a){j="";for(g=-1;++g<d;){j+="td:eq("+(k-g)+")";if(g!==d-1)j+=","}d--;
f.find(j).wrapAll("<tr></tr>");if(c===true){for(j="";++d<a;)j+="<td></td>";f.find("tr:last").append(j)}}d++});f[0].tagName!=="table"&&f.children("tr").wrapAll("<table></table>");return this}})(jQuery);
//