...
0?parseInt(f):false;e=parseInt(e)||false;g=parseInt(g)||false;var h=c===true?[]:-1;this.forEach(function(j,k){if(c===true)h.push(k);else h=k;return true},a||"",b,c,f,e,g);return h};d.Collection.prototype.searchOne=function(a,b){return this.search(a||"",b||"",false)};d.Collection.prototype.indexOf=function(a,b,c){c=c||"";b=b||"";var f=nimble.byLink(this._get("collection",c),this._getActiveParam("context"));if(d.isArray(f)&&f.indexOf){if(b)return f.indexOf(a,b);return f.indexOf(a)}else return this.search(function(e){return e===
...
nimble.CHILDREN+n,m===true?e:n+nimble.METHOD_SEPARATOR+e,f,c);i===true&&l.push(n)},this);else{this.add(b+nimble.CHILDREN+a,m===true?e:a+nimble.METHOD_SEPARATOR+e,f,c);i===true&&l.push(a)}i===true&&this.disable("context")._remove(l,c).enable("context");return this};d.Collection.prototype.moveOne=function(a,b,c,f,e){return this.move(a||"",d.isExists(b)?b.toString():"",c||"",f||"",e||"",false)};d.Collection.prototype.copy=function(a,b,c,f,e,g,h,j,k){g=g===false?false:true;h=parseInt(h)>=0?parseInt(h):
false;j=parseInt(j)||false;k=parseInt(k)||false;return this.move(a||"",d.isExists(b)?b.toString():"",c||"",f||"",e||"push",g,h,j,k,false)};d.Collection.prototype.copyOne=function(a,b,c,f,e){return this.move(a||"",d.isExists(b)?b.toString():"",c||"",f||"",e||"",false,"","","",false)};d.Collection.prototype.remove=function(a,b){if(d.isNumeric(a)||arguments.length<2&&d.isString(a)&&!this._filterTest(a)||arguments.length===0||arguments.length<2&&a===null)return this._removeOne(a,b||"");else if(d.isArray(a)||
d.isPlainObject(a))return this._remove(a,b||"");var c=this.search.apply(this,arguments),f;if(d.isArray(c))for(f=c.length;(f-=1)>-1;)this._removeOne(c[f],b);else this._removeOne(c,b);return this};d.Collection.prototype.removeOne=function(a,b){return this.remove(a||"",b||"",false)};d.Collection.prototype.group=function(a,b,c,f,e,g,h){a=this._exprTest(a=a||"")?this._compileFilter(a):a;c=c||"";h=h||false;f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;g=parseInt(g)||false;var j=d.isString(a),
k={};this.forEach(function(i,l){var m=j?nimble.byLink(i,a):a.apply(a,arguments);if(k[m])k[m].push(!h?i:l);else k[m]=[!h?i:l];return true},b,c,"",f,e,g);return k};d.Collection.prototype.groupLinks=function(a,b,c,f,e,g){return this.group(a||"",b||"",c||"",f||"",e||"",g||"",true)};d.Collection.prototype.stat=function(a,b,c,f,e,g,h){a=a||"count";f=f||"";e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;h=parseInt(h)||false;var j=d.isString(a),k=0,i=0,l=function(m){m=nimble.byLink(m,b||"");switch(a){case "count":k+=
1;break;case "summ":k+=m;break;case "avg":i+=1;k+=m;break;case "max":if(m>k)k=m;break;case "min":if(i===0){k=m;i=1}else if(m<k)k=m;break;default:if(j)if(i===0){k=m;i=1}else k=nimble.expr(a+"="+m,k);else k=a(m,k)}return true};if(a!=="first"&&a!=="last"){this.forEach(l,c||"",f,"",e,g,h);if(a==="avg")k/=i}else k=a==="first"?this._getOne(nimble.ORDER[0]+"0"+nimble.ORDER[1]):this._getOne(nimble.ORDER[0]+"-1"+nimble.ORDER[1]);return k};d.Collection.prototype.groupStat=function(a,b,c,f,e,g,h){a=a||"count";
f=f||"";e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;h=parseInt(h)||false;var j=d.isString(a),k={},i={},l,m=function(n){n=nimble.byLink(n,b||"");switch(a){case "count":k[this.i]+=1;break;case "summ":k[this.i]+=n;break;case "avg":i[this.i]+=1;k[this.i]+=n;break;case "max":if(n>k[this.i])k[this.i]=n;break;case "min":if(i[this.i]===0){k[this.i]=n;i[this.i]=1}else if(n<k[this.i])k[this.i]=n;break;default:if(j)if(i[this.i]===0){k[this.i]=n;i[this.i]=1}else k[this.i]=nimble.expr(a+"="+n,k[this.i]);
else k[this.i]=a(n,k[this.i])}return true};this.forEach(function(n,o,p,r,q,s){k[o]||(k[o]=i[o]=0);if(a!=="first"&&a!=="last")q._update("context","+="+nimble.CHILDREN+(m.i=o)).forEach(m,c||"",s,"",e,g,h).parent();else k[o]=a==="first"?nimble.byLink(n,nimble.ORDER[0]+"0"+nimble.ORDER[1]):nimble.byLink(n,nimble.ORDER[0]+"-1"+nimble.ORDER[1]);return true},"",f);if(a==="avg")for(l in k)if(k.hasOwnProperty(l))k[l]/=i[l];return k};d.Collection.prototype.sort=function(a,b,c,f){a=a||"";b=b||false;c=c&&c!==
true?c===false?"":c:function(i){if(isNaN(i))return i.toUpperCase();return i};f=f||"";var e=this,g,h=function(i,l){var m=b?-1:1;if(a){i=nimble.byLink(i,a);l=nimble.byLink(l,a)}if(c){i=c(i);l=c(l)}if(b!==e.SHUFFLE){if(i<l)return m*-1;if(i>l)return m;return 0}else return Math.floor(Math.random()*2-1)},j=function(i){var l=[],m={},n;for(n in i)i.hasOwnProperty(n)&&l.push(n);l.sort(h);for(n in l)if(l.hasOwnProperty(n))m[l[n]]=i[l[n]];return m},k=function(i){var l=[],m={},n;for(n in i)i.hasOwnProperty(n)&&
l.push({key:n,value:i[n]});a=a===true?"value":"value"+nimble.CHILDREN+a;l.sort(h);for(n in l)if(l.hasOwnProperty(n))m[l[n].key]=l[n].value;return m};g=nimble.byLink(this._get("collection",f),this._getActiveParam("context"));if(typeof g==="object")if(d.isArray(g))g.sort(h);else{g=a?k(g):j(g);this._setOne("",g,f)}else throw Error("incorrect data type!");return this};d.Collection.prototype.reverse=function(a){a=a||"";var b,c=function(f){var e=[],g={},h;for(h in f)f.hasOwnProperty(h)&&e.push(h);e.reverse();
for(h in e)if(e.hasOwnProperty(h))g[e[h]]=f[e[h]];return g};b=nimble.byLink(this._get("collection",a),this._getActiveParam("context"));if(typeof b==="object")d.isArray(b)?b.reverse():this._setOne("",c(b),a);else throw Error("incorrect data type!");return this};d.Collection.prototype.save=function(a,b){if(!localStorage)throw Error("your browser doesn't support web storage!");a=a||this.ACTIVE;var c="__"+this.name+"__"+this._get("namespace"),f=a===this.ACTIVE?this._exists("collection")?this._getActiveID("collection"):
"":this._isActive("collection",a)?"active":"",e=b===false?sessionStorage:localStorage;e.setItem(c+":"+a,this.toString(a));e.setItem(c+"__date:"+a,(new Date).toString());e.setItem(c+"__active:"+a,f);e.setItem(c+"__date",(new Date).toString());return this};d.Collection.prototype.saveAll=function(a){if(!localStorage)throw Error("your browser doesn't support web storage!");a=a===false?a:true;var b,c=this.dObj.sys.tmpCollection,f=false;this.dropAll(a);for(b in c){this._isActive("Collection",b)&&(f=true);
c.hasOwnProperty(b)&&this.save(b,a)}f===false&&this.save("",a);return this};d.Collection.prototype.load=function(a,b){if(!localStorage)throw Error("your browser doesn't support web storage!");a=a||this.ACTIVE;var c="__"+this.name+"__"+this._get("namespace"),f=b===false?sessionStorage:localStorage;a===this.ACTIVE?this._new("collection",d.parseJSON(f.getItem(c+":"+a))):this._push("collection",a,d.parseJSON(f.getItem(c+":"+a)));c=f.getItem(c+"__active:"+a);if(c===this.ACTIVE)this._set("collection",a);
else c&&this._push("collection",c,this._get("collection"))._set("collection",c);return this};d.Collection.prototype.loadAll=function(a,b){b=b?"drop":"load";if(!localStorage)throw Error("your browser doesn't support web storage!");a=a===false?a:true;var c="__"+this.name+"__"+this._get("namespace"),f=a===false?sessionStorage:localStorage,e=f.length,g,h;try{for(g in f)if(f.hasOwnProperty(g))if((h=g.split(":"))[0]===c)this[b](h[1],a)}catch(j){for(;(e-=1)>-1;)if((h=f[e].split(":"))[0]===c)this[b](h[1],
