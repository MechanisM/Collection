 ...
 */
 (function(h){function y(a){return a<10?"0"+a:a}function E(a){F.lastIndex=0;return F.test(a)?'"'+a.replace(F,function(c){var b=G[c];return typeof b==="string"?b:"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function B(a,c){var b,d,e,f,g=t,j,k=c[a];if(k&&typeof k==="object"&&typeof k.toJSON==="function")k=k.toJSON(a);if(typeof w==="function")k=w.call(c,a,k);switch(typeof k){case "string":return E(k);case "number":return isFinite(k)?String(k):"null";case "boolean":case "null":return String(k);
case "object":if(!k)return"null";t+=C;j=[];if(h.isArray(k)){f=k.length;for(b=0;b<f;b++)j[b]=B(b,k)||"null";e=j.length===0?"[]":t?"[\n"+t+j.join(",\n"+t)+"\n"+g+"]":"["+j.join(",")+"]";t=g;return e}if(w&&typeof w==="object"){f=w.length;for(b=0;b<f;b++)if(typeof w[b]==="string"){d=w[b];if(e=B(d,k))j.push(E(d)+(t?": ":":")+e)}}else for(d in k)if(Object.prototype.hasOwnProperty.call(k,d))if(e=B(d,k))j.push(E(d)+(t?": ":":")+e);e=j.length===0?"{}":t?"{\n"+t+j.join(",\n"+t)+"\n"+g+"}":"{"+j.join(",")+"}";
t=g;return e}}h.Collection=function(a,c){a=a||null;c=c||null;if(this.fn&&this.fn.jquery)return new h.Collection(a,c);h.extend(true,this,h.Collection.storage);var b=this.dObj.prop;c&&h.extend(true,b,c);if(h.isString(a)){b.activeTarget=h(a);b.activeCollection=null}else b.activeCollection=a};h.Collection.cache={};h.Collection.cache.templateMode={};h.Collection.cache.obj={contextSeparator:"~",subcontextSeparator:"#",methodSeparator:"::",getByLink:function(a,c){c=c.toString().split(this.contextSeparator);
...
a||{};var c=a.collection?a.collection.Count:"",b=this.dObj,d=b.sys,e=b.css,f=b.viewVal,g=b.prop;b=a.page||g.activePage;var j=a.selectorOut||g.activeSelectorOut,k=h(a.pager||g.activePager);c=a.countRecords||d.countRecords||c||0;j=a.countRecordsInPage||d.countRecordsInPage||h(j,g.activeTarget).length;g=a.countBreak||g.activeCountBreak;a=a.countTotal||d.countTotal||g*b-(g-j);d=e.pageNumber;var l=e.pagePrev,m=e.pageDisablePrev,o=e.pageNext;e=e.pageDisableNext;var n=f.aPrev,p=f.aNext;f=f.from;var r;if(b===
1&&j===c)h("."+l+",."+m+",."+o+",."+e,k).addClass(e);else{if(a===c)h("."+o,k).replaceWith('<div class="'+e+'">'+p+"</div>");else{r=h("."+e,k);r.length===1?r.replaceWith('<a href="javascript:;" class="'+o+'" data-action="set/page/next">'+p+"</a>"):h("."+o,k).removeClass(e)}if(b===1)h("."+l,k).replaceWith('<div class="'+m+'">'+n+"</div>");else{m=h("."+m,k);m.length===1?m.replaceWith('<a href="javascript:;" class="'+l+'" data-action="set/page/prev">'+n+"</a>"):h("."+l,k).removeClass(e)}}j===0?h("."+
d,k).html(0):h("."+d,k).html((b-1)*g+1+"-"+a+" "+f+" "+c);return true};h.Collection.cache.templateMode.controlMode=function(a){a=a||{};var c=a.collection?a.collection.Count:"",b=this.dObj,d=b.sys,e=b.css,f=b.viewVal,g=b.prop;b=a.page||g.activePage;var j=a.selectorOut||g.activeSelectorOut,k=h(a.pager||g.activePager);c=a.countRecords||d.countRecords||c||0;var l=a.countRecordsInPage||d.countRecordsInPage||h(j,g.activeTarget).length;j=a.countBreak||g.activeCountBreak;d=a.countTotal||d.countTotal||j*b-
(j-l);l=c%j!==0?~~(c/j)+1:c/j;var m="",o=e.pageActive,n=e.pagingLeft,p=e.pagingRight,r=e.pageDisablePrev;e=e.pageDisableNext;var q=f.aPrev,s=f.aNext,v=f.show;f=f.total;if(l>(a.pageBreak||g.activePageBreak)){m+=b!==1?'<a href="javascript:;" data-action="set/page[1">'+q+"</a>":'<div class="'+r+'">'+q+"</div>";g=0;for(a=b-1;a++<l;g++){if(g===0&&b!==1)m+='<a href="javascript:;" data-action="set/page['+(a-1)+'">'+(a-1)+"</a>";if(g===j-1)break;m+=a===b?'<a href="javascript:;" class="'+o+'">'+a+"</a>":'<a href="javascript:;" data-action="set/page['+
a+'">'+a+"</a>"}m+=a!==l+1?'\t\t\t\t\t<a href="javascript:;" data-action="set/page['+(a+1)+'">'+(a+1)+'</a>\t\t\t\t\t<a href="javascript:;" data-action="set/page['+l+'">'+s+"</a>\t\t\t\t":'<div class="'+e+'">'+s+"</div>"}else for(a=0;a++<l;)m+=a===b?'<a href="javascript:;" class="'+o+'">'+a+"</a>":'<a href="javascript:;" data-action="set/page['+a+'">'+a+"</a>";if(c===0)h("."+n+",."+p,k).empty();else{h("."+p,k).html(m);h("."+n,k).html(f+": "+c+". "+v+": "+((b-1)*j+1)+"-"+d)}return true};h.Collection.storage=
{dObj:{prop:{activeCollection:null,activePage:1,activeTarget:null,activeTemplate:null,activeTemplateMode:h.Collection.cache.templateMode.simpleMode,activeCountBreak:10,activePageBreak:10,activeFilter:false,activeParser:false,activeSelectorOut:".SelectorOut",activePager:"#PageControl",activeResultNull:false,activeVar:null,activeContext:"",activeAppendType:"html",activeDefer:"",activeCache:{autoIteration:false,iteration:false,firstIteration:-1,lastIteration:-1}}}};h.Collection.storage.dObj.sys={countRecords:null,
countRecordsInPage:null,countTotal:null,callbackCallee:null,filterCallee:null,templateCallee:null,templateModeCallee:null,parserCallee:null};(function(a){var c,b,d=h.Collection.storage.dObj.sys;for(c=a.length;c--;){b=a[c].substring(0,1).toLowerCase()+a[c].substring(1);d["active"+a[c]+"ID"]=null;d["tmp"+a[c]]={};d[b+"ChangeControl"]=null;d[b+"Back"]=[]}})(["Collection","Page","Target","Filter","Parser","Var","Template","TemplateMode","Context","CountBreak","PageBreak","Pager","SelectorOut","ResultNull",
"AppendType","Defer","Cache"]);h.Collection.storage.dObj.viewVal={aPrev:"&lt;&lt;",aNext:"&gt;&gt;",total:"Total",show:"Show",from:"From",noResultInSearch:"Nothing was found"};h.Collection.storage.dObj.css={pageNumber:"pageNumber",pagePrev:"pagePrev",pageDisablePrev:"pageDisablePrev",pageNext:"pageNext",pageDisableNext:"pageDisableNext",pageActive:"pageActive",pagingRight:"pagingRight",pagingLeft:"pagingLeft",noResult:"noResult"};h.Collection.fn._mod=function(a,c,b){var d=this.dObj,e=d.prop,f=d.sys;
d="active"+a;a=f["tmp"+a];f=f[d+"ID"];var g=function(j,k){if(h.isNumber(j)||h.isString(j))j+=k;else if(h.isArray(j))j.push(k);else if(h.isBoolean(j))j=k===true&&j===true?false:true;return j};if(b&&b!==this.active){a[b]=g(a[b],c);if(f&&b===f)e[d]=a[b]}else{e[d]=g(e[d],c);if(f)a[f]=e[d]}return this};h.Collection.fn._push=function(a,c,b){var d=this.dObj.sys,e=d["tmp"+a];d=d["active"+a+"ID"];var f;if(h.isPlainObject(c))for(f in c){if(c.hasOwnProperty(f))if(f===this.active)throw Error("Invalid property name!");
...
false;g=parseInt(g)||false;var j=this.dObj,k=j.prop,l=j.sys,m,o=0;j.sys.callbackCallee=a;if(a.before)if(a.before.apply(this,arguments)===false)return this;j=h.Collection.cache.obj.getByLink(b!==this.active?l.tmpCollection[b]:k.activeCollection,k.activeContext);k=this.length(j);if(h.isArray(j)){l=k-1;for(m=g!==false?g-1:-1;m++<l;){if(e!==false&&o===e)break;if(a.beforeFilter)if(a.beforeFilter(j,m,k,this,b)===false)return this;if(c===false||this.customFilter(c,j,m,k,this,b)===true){if(f!==false&&f!==
0){f--;continue}if(a.call(this,j,m,k,this,b)===false)break;if(d===false)break;o++}if(a.afterFilter)if(a.afterFilter(j,m,k,this,b)===false)return this}}else for(m in j)if(j.hasOwnProperty(m)){if(e!==false&&o===e)break;if(g!==false&&g!==0)g--;else{if(a.beforeFilter)if(a.beforeFilter(j,m,k,this,b)===false)return this;if(c===false||this.customFilter(c,j,m,k,this,b)===true){if(f!==false&&f!==0){f--;continue}if(a.call(this,j,m,k,this,b)===false)break;if(d===false)break;o++}if(a.afterFilter)if(a.afterFilter(j,
m,k,this,b)===false)return this}}a.after&&a.after.apply(this,arguments);return this};h.Collection.fn.searchElements=function(a,c,b,d,e,f){a=a||false;c=h.isExist(c)?c:this.active;if(h.isBoolean(c)){f=e;e=d;d=b;b=c;c=this.active}b=b===false?false:true;d=parseInt(d)>=0?parseInt(d):false;e=parseInt(e)||false;f=parseInt(f)||false;var g=[];this.each(function(j,k){if(b===true)g.push(k);else{g=k;return false}return true},a,c,b,d,e,f);return g};h.Collection.fn.searchElement=function(a,c){return this.searchElements(a||
...
function(a,c,b,d,e,f,g){a=a||false;b=h.isExist(b)?b:this.active;if(h.isBoolean(b)){g=f;f=e;e=d;d=b;b=this.active}d=d===false?false:true;e=parseInt(e)>=0?parseInt(e):false;f=parseInt(f)||false;g=parseInt(g)||false;var j=h.isFunction(c);this.each(function(k,l,m,o,n){if(j)c(k,l,m,o,n);else k[l]=c;return true},a,b,d,e,f,g);return this};h.Collection.fn.replaceElement=function(a,c,b){return this.replaceElements(a||"",c,b||"",false)};h.Collection.fn.moveElements=function(a,c,b,d,e,f,g,j,k,l){a=a||false;
l=l===false?false:true;c=h.isExist(c)?c.toString():"";b=b||"";d=d||"";e=e||"push";f=f===false?false:true;g=parseInt(g)>=0?parseInt(g):false;j=parseInt(j)||false;k=parseInt(k)||false;var m=h.Collection.cache.obj,o=this.dObj,n=o.sys,p,r=[];o=h.isArray(m.getByLink(this._get("Collection",d),o.prop.activeContext));if(n.activeContextID){n=n.activeContextID;p=true}else{n=this._get("Context");p=false}this._$("Context",c);a=this.searchElements(a,b,f,g,j,k);p===true?this._set("Context",n):this._$("Context",
n);if(f===true){f=a.length-1;for(g=-1;g++<f;){this.addElement(c+m.contextSeparator+a[g],o===true?e:a[g]+m.methodSeparator+e,d,b);l===true&&r.push(a[g])}}else{this.addElement(c+m.contextSeparator+a,o===true?e:a+m.methodSeparator+e,d,b);l===true&&r.push(a)}if(l===true){this._$("Context",c);this.deleteElementsByLink(r,b);p===true?this._set("Context",n):this._$("Context",n)}return this};h.Collection.fn.moveElement=function(a,c,b,d,e){return this.moveElements(a||"",h.isExist(c)?c.toString():"",b||"",d||
...
l=j.sys,m,o,n=true,p,r,q,s=-1;if(h.isFunction(a)){j.sys.filterCallee=a;return a(c,b,d,e,f)}if(!a||h.isString(a)&&h.trim(a)===this.active){if(k.activeFilter){j.sys.filterCallee=k.activeFilter;return k.activeFilter(c,b,d,e,f)}return true}else{if(!h.isArray(a)){if(a.search(/\|\||&&|!|\(|\)/)===-1){j.sys.filterCallee=l.tmpFilter[a];return l.tmpFilter[a](c,b,d,e,f)}a=h.trim(a.toString().replace(/\s*(\(|\))\s*/g," $1 ").replace(/\s*(\|\||&&)\s*/g," $1 ").replace(/(!)\s*/g,"$1")).split(" ")}o=function(v,
x){for(var u=-1,D=v.length-1,z=0,A=[];u++<D;){x++;v[u]==="("&&z++;if(v[u]===")")if(z===0)return{result:A,iter:x};else z--;A.push(v[u])}};for(m=a.length-1;s++<m;)if(a[s]==="("||a[s]==="!("){if(a[s].substring(0,1)==="!"){q=true;a[s]=a[s].substring(1)}else q=false;g=o(a.slice(s+1),s);s=g.iter;g=this.customFilter(g.result,c,b,d,e,f);n=!p&&!r?q===true?!g:g:p?q===true?!g:g&&n:q===true?!g:g||n}else if(a[s]!==")"&&a[s]!=="||"&&a[s]!=="&&"){if(a[s].substring(0,1)==="!"){q=true;a[s]=a[s].substring(1)}else q=
false;g=a[s]===this.active?k.activeFilter:l.tmpFilter[a[s]];j.sys.filterCallee=g;g=g(c,b,d,e,f);n=!p&&!r?q===true?!g:g:p?q===true?!g:g&&n:q===true?!g:g||n}else if(a[s]==="||"){p=false;r=true}else if(a[s]==="&&"){r=false;p=true}return n}};h.Collection.fn.customParser=function(a,c){var b=this.dObj,d=b.prop,e=b.sys,f,g;if(h.isFunction(a)){b.sys.parserCallee=a;return a(c,this)}if(!a||h.isString(a)&&h.trim(a)===this.active){if(d.activeParser){b.sys.parserCallee=d.activeParser;return d.activeParser(c,this)}}else{if(h.isString(a)){a=
...
h.Collection.fn.parent=function(a,c){var b=this.dObj,d=b.sys,e=b.prop;b=b.sys.activeContextID;var f=this.parentContext.apply(this,arguments);if(!c||c===this.active){if(b)d.tmpContext[b]=f;e.activeContext=f}else{d.tmpContext[c]=f;if(b&&c===b)e.activeContext=f}return this};h.Collection.fn.orderBy=function(a,c,b,d){a=a||null;c=c||false;b=b?b===false?null:b:function(l){if(isNaN(l))return l.toUpperCase();return l};d=d||"";var e=h.Collection.cache,f=this.dObj,g=f.prop,j=f.sys;f=function(l){var m=[],o={},
n;for(n in l)l.hasOwnProperty(n)&&m.push(n);m.sort(e.sort.sortBy(a,c,b));for(n in m)if(m.hasOwnProperty(n))o[m[n]]=l[m[n]];return o};var k=function(l){var m=[],o={},n;for(n in l)l.hasOwnProperty(n)&&m.push({key:n,value:l[n]});m.sort(e.sort.sortBy(a===true?"value":"value"+e.obj.contextSeparator+a,c,b));for(n in m)if(m.hasOwnProperty(n))o[m[n].key]=m[n].value;return o};g=e.obj.getByLink(d?j.tmpCollection[d]:g.activeCollection,g.activeContext);if(typeof g==="object")if(h.isArray(g))g.sort(e.sort.sortBy(a,
c,b));else{g=a?k.call(this,g):f.call(this,g);this.setElement("",g,d||"")}else throw Error("Incorrect data type!");return this};h.Collection.fn.toString=function(a,c,b){var d=this.dObj,e=d.prop;C=t="";a=a&&h.isString(a)&&a!==this.active?d.sys.tmpCollection[a]:typeof a==="object"?a:e.activeCollection;a=h.Collection.cache.obj.getByLink(a,e.activeContext);if(typeof b==="number")for(e=b;e--;)C+=" ";else if(typeof b==="string")C=b;w=c;if(window.JSON!==undefined)return JSON.stringify(a,c,b);return B("",
{"":a})};h.Collection.fn.valueOf=function(a){return this.length(h.isExist(a)?a:this.active)};if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+y(this.getUTCMonth()+1)+"-"+y(this.getUTCDate())+"T"+y(this.getUTCHours())+":"+y(this.getUTCMinutes())+":"+y(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()}}var F=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
t,C,G={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},w;h.Collection.fn.then=function(a,c){var b=this;arguments.length===1?h.when(this.prop("activeDefer")).always(function(){a.apply(b,arguments)}):h.when(this.prop("activeDefer")).then(function(){a().apply(b,arguments)},function(){c().apply(b,arguments)});return this};h.Collection.fn.print=function(a,c,b,d,e){a=a||{};c=c===false?false:true;b=parseInt(b)>=0?parseInt(b):false;d=parseInt(d)||false;e=parseInt(e)||
false;var f=this.dObj,g=f.prop,j=a.filter||g.activeFilter,k=a.parser||g.activeParser,l=a.template||g.activeTemplate,m=a.target||a.target===false?a.target:g.activeTarget,o=a.appendType||g.activeAppendType;g=a.resultNull!==undefined?a.resultNull:g.activeResultNull;var n=f.viewVal.noResultInSearch,p="";f.sys.templateCallee=l;this.each(function(r,q,s,v,x){p+=l(r,q,s,v,x);if(c!==true)return false;return true},j,"active",c,b,d,e);p=!p?g===false?'<div class="'+f.css.noResult+'">'+n+"</div>":g:p;p=k!==false?
this.customParser(k,p):p;if(m===false)a.variable?this.PushSetVar(a.variable,p):this.$Var(p);else m[o](p);return this};h.Collection.fn.extPrint=function(a){a=a||{};var c=this.dObj,b=c.sys,d=c.prop,e,f,g=0,j=a.filter?a.filter:d.activeFilter,k=a.parser?a.parser:d.activeParser;e=a.context||d.activeContext;var l=a.page||d.activePage,m=l===a.page+1,o=a.template||d.activeTemplate,n=a.target||d.activeTarget,p=a.appendType||d.activeAppendType,r=+a.countBreak||+d.activeCountBreak,q=d.activeCache;f=h.isBoolean(a.cacheIteration)?
a.cacheIteration:q.iteration;var s=a.selectorOut||d.activeSelectorOut,v=a.resultNull!==undefined?a.resultNull:d.activeResultNull,x=c.viewVal.noResultInSearch,u="",D=function(z,A,H,I,J){u+=o(z,A,H,I,J);g=A;return true};d=h.Collection.cache.obj.getByLink(d.activeCollection,e);e=this.length();r=r===false?e:r;c.sys.templateCallee=o;if(h.isPlainObject(d)||f===false)this.each(D,j,"active",true,r,l===1?r:(l-1)*r);else if(h.isArray(d)&&f===true){f=j===false?l===1?-1:(l-1)*r-1:f===true?m===true?q.firstIteration:
q.lastIteration:i;if(m===true&&j!==false){for(;f--;)if(this.customFilter(j,d,f,e,this,"active")===true)if(g===r)break;else g++;f=f===-1?f:f+1;q.lastIteration=f}this.each(D,j,"active",true,r,null,f);q.firstIteration=q.lastIteration;q.lastIteration=g-1;if(q.autoIteration===true)q.iteration=true}u=!u?v===false?'<div class="'+c.css.noResult+'">'+x+"</div>":v:u;u=k!==false?this.customParser(k,u):u;n[p](u);b.countRecords=this.length(j);b.countRecordsInPage=h(s,n).length;b.countTotal=r*l-(r-b.countRecordsInPage);
h.extend(a,{countRecords:b.countRecords,countRecordsInPage:b.countRecordsInPage,countTotal:b.countTotal});if(l!==1&&b.countRecordsInPage===0){c.prop.activePage--;this.extPrint.apply(this,arguments)}else this.easyPage(a,c.prop);return this};h.Collection.fn.easyPage=function(){this.dObj.sys.templateModeCallee=this.dObj.prop.activeTemplateMode;this.dObj.prop.activeTemplateMode.apply(this,arguments);return this};h.Collection.fn.genTable=function(a){a=a||4;var c=1,b,d=this.dObj.prop.activeTarget,e=d.children("td").length-
1,f=a-1,g="";d.children("td").each(function(j){if(c===a){g="";for(b=-1;b++<f;){g+="td:eq("+(j-b)+")";if(b!==f)g+=","}h(g,d).wrapAll("<tr></tr>");c=0}else if(j===e&&c!==a){g="";for(b=0;b<c;b++){g+="td:eq("+b+")";if(b!==c-1)g+=","}d.children(g).wrapAll("<tr></tr>");for(g="";c<a;c++)g+="<td></td>";d.children("tr:last").append(g)}c++});d.children("tr").wrapAll("<table></table>");return this};h.fn.collection=function(a){var c=h.fn.collection.stat,b=function(e){var f=[];e.each(function(g){var j=h(this),
k=j.data(),l=j.attr("class")?j.attr("class").split(" "):"",m=l?l.length:0,o;o=j[0];o=o.childNodes;for(var n=o.length-1,p=-1,r="";p++<n;)if(o[p].nodeType===3&&h.trim(o[p].textContent))r+=o[p].textContent;o=r?r:false;var q;f.push({});for(q in k)if(k.hasOwnProperty(q))f[g][q]=k[q];if(m){f[g][c.classes]={};for(q=0;q<m;q++)f[g][c.classes][l[q]]=l[q]}if(j.children().length!==0)f[g][c.childNodes]=b(j.children());if(o!==false)f[g][c.val]=o.replace(/[\r\t\n]/g," ")});return f},d=b(this);if(a)return new h.Collection(d,
a);return new h.Collection(d)};if(!h.fn.collection.stat)h.fn.collection.stat={val:"val",childNodes:"childNodes",classes:"classes"};h.fn.tplCompile=function(){if(this.length===0)throw Error("DOM element isn't exist!");for(var a=this.eq(0).html().split("?>").join("<?js").replace(/[\r\t\n]/g," ").split("<?js"),c=a.length-1,b="var result = ''",d="",e=-1,f,g;e++<c;)if(e===0||e%2===0)b+="+'"+a[e]+"'";else{f=-1;a[e]=a[e].split("`");for(g=a[e].length;f++<g;)if(f===0||f%2===0)a[e][f]&&(d+=a[e][f]);else a[e][f]&&
(b+="+"+a[e][f])}b+=";";return new Function("$this","i","aLength","$obj","id",b+d+" return result;")};h.isString=function(a){return Object.prototype.toString.call(a)==="[object String]"};h.isBoolean=function(a){return Object.prototype.toString.call(a)==="[object Boolean]"};h.isNumber=function(a){return Object.prototype.toString.call(a)==="[object Number]"};h.isExist=function(a){return a!==undefined&&a!=="undefined"&&a!==null&&a!==""};h.unshiftArguments=function(a,c){for(var b=[c],d=0,e=a.length;d<
e;d++)b.push(a[d]);return b}})(jQuery);
//