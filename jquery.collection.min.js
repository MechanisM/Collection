...
true?!n:n||m}else if(a[b]==="||"){o=false;p=true}else if(a[b]==="&&"){p=false;o=true}return m};d.Collection.prototype._compileFilter=function(a){var c=/^\s*\(*\s*/.exec(a);if(c.length!==0)a=a.substring(c[0].length+1,a.length-c[0].length);a=a.split("<:").join('self.getVariable("').split(":>").join('")');return new Function("el","i","data","cOLength","cObj","id","var key = i; return "+a.replace(/^\s*:/,"")+";")};d.Collection.prototype._customParser=function(a,c,b){if(!a||d.isString(a)&&(a=d.trim(a))===
this.ACTIVE){if(!this._getActiveParam("parser")&&a!==this.ACTIVE)return true;if(this._get("parser")){if(d.isFunction(this._get("parser")))return this._get("parser").call(this._get("parser"),c,this);return this._customParser(this._get("parser"),c,b)}return true}if(d.isFunction(a))if(!this._getActiveParam("parser")||!b)return a.call(a,c,this);else{if(!b.name){for(;this._exists("parser","__tmp:"+(b.name=d.getRandomInt(0,1E4)));)b.name=d.getRandomInt(0,1E4);this._push("parser","__tmp:"+b.name,a)}return this._customParser(this.ACTIVE+
" && __tmp:"+b.name,c,b)}if(d.isString(a)){a=d.trim(a);console.log(a);if(a.search("&&")===-1)return this._customParser(this._get("parser",a),c);a=a.split("&&")}if(this._getActiveParam("parser"))c=this._get("parser").call(this._get("parser"),c,this);a.forEach(function(e){e=d.trim(e);c=d.isString(e)?this._customParser(e,c):this._get("parser",e).call(this._get("parser",e),c,this)},this);return c};d.Collection.prototype._compileParser=function(a){var c=/^\s*\(*\s*/.exec(a);console.log(c);if(c.length!==
0)a=a.substring(c[0].length+1,a.length-c[0].length);a=a.split("<:").join('self.getVariable("').split(":>").join('")');return new Function("str","cObj","return "+a.replace(/^\s*:/,"")+";")};d.Collection.prototype.parentContext=function(a,c){for(var b=this._get("context",c||"").split(nimble.CHILDREN),e=a||1;(e-=1)>-1;)b.splice(-1,1);return b.join(nimble.CHILDREN)};d.Collection.prototype.parent=function(a,c){if(!c)return this._update("context",this.parentContext.apply(this,arguments));return this._push("context",
c,this.parentContext.apply(this,arguments))};d.Collection.prototype._getActiveParam=function(a){var c=this.dObj.sys.flags.use[a]===undefined||this.dObj.sys.flags.use[a]===true?this.dObj.active[a]:false;if(a==="context")return c?c.toString():"";return c};d.Collection.prototype._filterTest=function(a){return a===this.ACTIVE||this._exists("filter",a)||a.search(/&&|\|\||:/)!==-1};d.Collection.prototype.enable=function(a){this.dObj.sys.flags.use[a]=true;return this};d.Collection.prototype.disable=function(a){this.dObj.sys.flags.use[a]=
false;return this};d.Collection.prototype.toggle=function(a){if(this.dObj.sys.flags.use[a]===true)return this.disable(a);return this.enable(a)};d.Collection.prototype.toString=function(a,c,b){if(!JSON||!JSON.stringify)throw Error("object JSON is not defined!");c=c||"";b=b||"";if(a&&(d.isArray(a)||d.isPlainObject(a)))return JSON.stringify(a,c,b);return JSON.stringify(nimble.byLink(this._get("collection",a||""),this._getActiveParam("context")),c,b)};d.Collection.prototype.valueOf=function(){return this.length(this.ACTIVE)};
d.Collection.prototype.then=function(a,c){var b=this;arguments.length===1?d.when(this.active("defer")).always(function(){a.apply(b,arguments)}):d.when(this.active("defer")).then(function(){a().apply(b,arguments)},function(){c().apply(b,arguments)});return this};d.Collection.prototype.print=function(a,c){c=c||false;var b={},e,g,f,j=0,h,l=null,k="",m;if(d.isExists(a)&&(d.isString(a)||d.isNumeric(a)))a={page:a};else d.isExists(a)||(a={page:this._get("page")});d.extend(true,b,this.dObj.active,a);if(a)b.page=
nimble.expr(b.page,this._get("page"));if(b.page<1)b.page=1;b.collection=d.isString(b.collection)?this._get("collection",b.collection):b.collection;b.template=d.isString(b.template)?this._get("template",b.template):b.template;b.cache=d.isExists(a.cache)?a.cache:this._getActiveParam("cache");if(c===true)b.cache.iteration=false;h=this._get("page")-b.page;this._update("page",b.page);m=function(n,o,p,q,r,t){b.callback&&b.callback.apply(this,arguments);k+=b.template.call(b.template,n,o,p,q,r,t);j=o;return true};
e=nimble.byLink(b.collection,this._getActiveParam("context")+nimble.CHILDREN+(a&&a.context||""));g=this.length();b.numberBreak=!d.isExists(b.numberBreak)||b.numberBreak===false?g:b.numberBreak;if(d.isPlainObject(e)||b.cache.iteration===false||b.cache.firstIteration===false||b.cache.lastIteration===false){f=!b.pager||b.page===1?0:(b.page-1)*b.numberBreak;this.forEach(m,b.filter,this.ACTIVE,true,b.numberBreak,f);if(b.cache.iteration===false)b.cache.lastIteration=false}else if(d.isArray(e)&&b.cache.iteration===
true){f=!b.pager||b.filter===false?b.page===1?0:(b.page-1)*b.numberBreak:b.cache.iteration===true?h>=0?b.cache.firstIteration:b.cache.lastIteration:i;if(h>0&&b.pager===true&&b.filter!==false){for(h*=b.numberBreak;(f-=1)>-1;)if(this._customFilter(b.filter,e[f],e,f,g,this,this.ACTIVE)===true)if(j===h)break;else j+=1;b.cache.lastIteration=f+=1;l=null}else if(h<0&&b.pager&&b.filter!==false)l=Math.abs(h)*b.numberBreak-b.numberBreak||null;this.forEach(m,b.filter,this.ACTIVE,true,b.numberBreak,l,f)}if(h!==
0&&b.cache.iteration!==false){this._get("cache").firstIteration=b.cache.lastIteration;this._get("cache").lastIteration=j+1}if(b.cache.autoIteration===true)this._get("cache").iteration=true;k=!k?b.resultNull:this._customParser(b.parser,k);if(b.target===false){b.variable?this._push("variable",b.variable,k):this._new("variable",k);return this}else b.target[b.appendType](k);if(!b.pager)return this;b.nmbOfEntries=b.filter!==false?this.length(b.filter):g;b.nmbOfEntriesInPage=b.target.find(b.calculator).length;
b.finNumber=b.numberBreak*b.page-(b.numberBreak-b.nmbOfEntriesInPage);b.page!==1&&b.nmbOfEntriesInPage===0?this.updatePage(b.page-=1).print(b,true,true):this.easyPage(b);return this};d.Collection.prototype.easyPage=function(a){var c=this,b="",e=a.nmbOfEntries%a.numberBreak!==0?~~(a.nmbOfEntries/a.numberBreak)+1:a.nmbOfEntries/a.numberBreak,g=function(k,m,n){var o,p="<"+(k.tag||"span")+' data-page="'+n+'"';if(k.attr)for(o in k.attr)if(k.attr.hasOwnProperty(o))p+=" "+o+'="'+k.attr[o]+'"';if(n===a.page)p+=
' class="'+(m&&m.active||"active")+'"';return p+(">"+n+"</"+(k.tag||"span")+">")},f,j=0,h,l;a.pager.find(".ctm").each(function(){if(a.pageBreak<=2)throw Error('parameter "pageBreak" must be more than 2');var k=d(this),m=k.data("ctm"),n=m.classes;if(m.nav){if((m.nav==="prev"||m.nav==="next")&&!k.data("ctm-delegated"))k.click(function(){if(!d(this).hasClass(m.classes&&m.classes.disabled||"disabled")){m.nav==="prev"&&(a.page="-=1");m.nav==="next"&&(a.page="+=1");db.print(a)}}).data("ctm-delegated",true);
if(m.nav==="prev"&&a.page===1||m.nav==="next"&&a.finNumber===a.nmbOfEntries)k.addClass(n&&n.disabled||"disabled");else if(m.nav==="prev"||m.nav==="next")k.removeClass(n&&n.disabled||"disabled");if(m.nav==="pageList"){if(e>a.pageBreak){j=a.pageBreak%2!==0?1:0;l=h=(a.pageBreak-j)/2;if(a.page-j<h)h=0;else{h=a.page-h-j;if(a.page+l>e)h-=a.page+l-e}f=h;for(j=-1;(f+=1)<=e&&(j+=1)!==null;){if(j===a.pageBreak&&f!==a.page)break;b+=g(m,n||"",f)}}else for(f=0;(f+=1)<=e;)b+=g(m,n||"",f);k.html(b);k.data("ctm-delegated")||
k.on("click",m.tag||"span",function(){var o=d(this);if(!o.hasClass(m.classes&&m.classes.active||"active")){a.page=o.data("page");c.print(a)}}).data("ctm-delegated",true)}}else if(m.info){a.nmbOfEntriesInPage===0?k.addClass(n&&n.noData||"noData"):k.removeClass(n&&n.noData||"noData");switch(m.info){case "page":k.html(a.page);break;case "total":k.html(a.nmbOfEntries);break;case "from":k.html((a.page-1)*a.numberBreak+1);break;case "to":k.html(a.finNumber);break;case "inPage":k.html(a.nmbOfEntriesInPage);
break;case "nmbOfPages":k.html(a.nmbOfPages)}}});return this};d.Collection.prototype.genTable=function(a,c,b){a=a||4;c=c||"div";b=b===false?false:true;var e=1,g,f=this._get("target"),j=f.find(c).length,h="";f.find(c).each(function(l){this.tagName!=="td"&&d(this).wrap("<td></td>");if(e===a){h="";for(g=-1;(g+=1)<a;){h+="td:eq("+(l-g)+")";if(g!==a-1)h+=","}f.find(h).wrapAll("<tr></tr>");e=0}else if(l===j-1&&e!==a){h="";for(g=-1;(g+=1)<e;){h+="td:eq("+(l-g)+")";if(g!==e-1)h+=","}e-=1;f.find(h).wrapAll("<tr></tr>");
if(b===true){for(h="";(e+=1)<a;)h+="<td></td>";f.find("tr:last").append(h)}}e+=1});f[0].tagName!=="table"&&f.children("tr").wrapAll("<table></table>");return this}})(jQuery);
//