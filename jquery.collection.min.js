...
return e};f.Collection.fn.each=function(a,b,d,c,g,e,h){b=f.isExist(b)?b:this.config.constants.active;d=f.isExist(d)?d:this.config.constants.active;if(f.isBoolean(d)){h=e;e=g;g=c;c=d;d=this.config.constants.active}c=c===false?false:true;g=parseInt(g)>=0?parseInt(g):false;e=parseInt(e)||false;h=parseInt(h)||false;var j=this.dObj,k=j.active,l=j.sys,m,n;j=0;k=f.Collection.obj.getByLink(d!==this.config.constants.active?l.tmpCollection[d]:k.collection,this.getActiveContext());l=this.length(k);if(f.isArray(k)){m=
l-1;for(n=h!==false?h-1:-1;n++<m;){if(g!==false&&j===g)break;if(b===false||this.customFilter(b,k,n,l,this,d)===true)if(e!==false&&e!==0)e--;else{if(a.call(a,k,n,l,this,d)===false)break;if(c===false)break;j++}}}else for(n in k)if(k.hasOwnProperty(n)){if(g!==false&&j===g)break;if(h!==false&&h!==0)h--;else if(b===false||this.customFilter(b,k,n,l,this,d)===true)if(e!==false&&e!==0)e--;else{if(a.call(a,k,n,l,this,d)===false)break;if(c===false)break;j++}}return this};f.Collection.fn.searchElements=function(a,
b,d,c,g,e){a=a||false;b=f.isExist(b)?b:this.config.constants.active;if(f.isBoolean(b)){e=g;g=c;c=d;d=b;b=this.config.constants.active}d=d===false?false:true;c=parseInt(c)>=0?parseInt(c):false;g=parseInt(g)||false;e=parseInt(e)||false;var h=[];this.each(function(j,k){if(d===true)h.push(k);else{h=k;return false}return true},a,b,d,c,g,e);return h};f.Collection.fn.searchElement=function(a,b){return this.searchElements(a||"",b||"",false)};f.Collection.fn.returnElements=function(a,b,d,c,g,e){a=a||false;
b=f.isExist(b)?b:this.config.constants.active;if(f.isBoolean(b)){e=g;g=c;c=d;d=b;b=this.config.constants.active}d=d===false?false:true;c=parseInt(c)>=0?parseInt(c):false;g=parseInt(g)||false;e=parseInt(e)||false;var h=[];this.each(function(j,k){if(d===true)h.push(j[k]);else{h=j[k];return false}return true},a,b,d,c,g,e);return h};f.Collection.fn.returnElement=function(a,b){return this.returnElements(a||"",b||"",false)};f.Collection.fn.replaceElements=function(a,b,d,c,g,e,h){a=a||false;d=f.isExist(d)?
d:this.config.constants.active;if(f.isBoolean(d)){h=e;e=g;g=c;c=d;d=this.config.constants.active}c=c===false?false:true;g=parseInt(g)>=0?parseInt(g):false;e=parseInt(e)||false;h=parseInt(h)||false;var j=f.isFunction(b);this.each(function(k,l,m,n,o){if(j)b.call(b,k,l,m,n,o);else k[l]=b;return true},a,d,c,g,e,h);return this};f.Collection.fn.replaceElement=function(a,b,d){return this.replaceElements(a||"",b,d||"",false)};f.Collection.fn.moveElements=function(a,b,d,c,g,e,h,j,k,l){a=a||false;l=l===false?
false:true;b=f.isExist(b)?b.toString():"";d=d||"";c=c||"";g=g||"push";e=e===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=parseInt(j)||false;k=parseInt(k)||false;var m=this.config.constants,n=[],o=f.isArray(f.Collection.obj.getByLink(this._get("collection",c),this.getActiveContext())),r=-1;this.disable("ac");a=this.searchElements(a,d,e,h,j,k);this.enable("ac");if(e===true)for(e=a.length-1;r++<e;){this.addElement(b+m.contextSeparator+a[r],o===true?g:a[r]+m.methodSeparator+g,c,d);l===true&&
n.push(a[r])}else{this.addElement(b+m.contextSeparator+a,o===true?g:a+m.methodSeparator+g,c,d);l===true&&n.push(a)}l===true&&this.disable("ac").deleteElementsByLink(n,d).enable("ac");return this};f.Collection.fn.moveElement=function(a,b,d,c,g){return this.moveElements(a||"",f.isExist(b)?b.toString():"",d||"",c||"",g||"",false)};f.Collection.fn.copyElements=function(a,b,d,c,g,e,h,j,k){e=e===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=parseInt(j)||false;k=parseInt(k)||false;return this.moveElements(a||
"",f.isExist(b)?b.toString():"",d||"",c||"",g||"push",e,h,j,k,false)};f.Collection.fn.copyElement=function(a,b,d,c,g){return this.moveElements(a||"",f.isExist(b)?b.toString():"",d||"",c||"",g||"",false,"","","",false)};f.Collection.fn.deleteElements=function(a,b,d,c,g,e){a=a||false;b=f.isExist(b)?b:this.config.constants.active;if(f.isBoolean(b)){e=g;g=c;c=d;d=b;b=this.config.constants.active}d=d===false?false:true;c=parseInt(c)>=0?parseInt(c):false;g=parseInt(g)||false;e=parseInt(e)||false;a=this.searchElements(a,
b,d,c,g,e);if(d===false)this.deleteElementByLink(a,b);else for(d=a.length;d--;)this.deleteElementByLink(a[d],b);return this};f.Collection.fn.deleteElement=function(a,b){return this.deleteElements(a||"",b||"",false)};f.Collection.fn.customFilter=function(a,b,d,c,g,e){var h,j=this.config.constants,k=this.dObj,l=k.active;k=k.sys;var m,n,o=true,r,s,p,q=-1;if(f.isFunction(a))return a.call(a,b,d,c,g,e);if(!a||f.isString(a)&&f.trim(a)===j.active){if(l.filter)return l.filter.call(l.filter,b,d,c,g,e);return true}else{if(!f.isArray(a)){if(a.search(/\|\||&&|!|\(|\)/)===
