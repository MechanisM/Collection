...
return this};d.Collection.fn.push=function(){for(var a=-1,b=arguments.length;(a+=1)<b;)this.add(arguments[a]);return this};d.Collection.fn.unshift=function(){for(var a=arguments.length;(a-=1)>-1;)this.add(arguments[a],"unshift");return this};d.Collection.fn.deleteElementByLink=function(a,b){a=d.isExist(a)?a.toString():"";var c=this.getActiveParam("context").toString();!a&&!c?this.set("",null):nimble.byLink(this._get("collection",b||""),c+nimble.CHILDREN+a,"",true);return this};d.Collection.fn.deleteElementsByLink=
function(a,b){b=b||"";var c,f;if(d.isPlainObject(a))for(c in a){if(a.hasOwnProperty(c))if(d.isArray(a[c]))for(f=a[c].length;(f-=1)>-1;)this.deleteElementByLink(a[c][f],c);else this.deleteElementByLink(a[c],c)}else if(d.isArray(a))for(f=a.length;(f-=1)>-1;)this.deleteElementByLink(a[f],b);else this.deleteElementByLink(a,b);return this};d.Collection.fn.pop=function(){return this.deleteElementByLink("eq(-1)")};d.Collection.fn.shift=function(){return this.deleteElementByLink("eq(0)")};d.Collection.fn.concat=
function(a,b,c){b=d.isExist(b)?b.toString():"";c=c||"";var f=nimble.byLink(this._get("collection",c),this.getActiveParam("context").toString()+nimble.CHILDREN+b);if(typeof f==="object")if(d.isPlainObject(f))d.extend(true,f,a);else{if(d.isArray(f))if(d.isArray(a)){f=Array.prototype.concat(f,a);this.set(b,f,c)}else this.add(a,"push",c)}else throw Error("incorrect data type!");return this};d.Collection.fn.length=function(a,b){a=d.isExist(a)?a:this.getActiveParam("filter");var c=this.dObj,f,e,g,h,j;if(!d.isFunction(a))if(d.isString(a)&&
!d.isExist(b)||d.isArray(a)||d.isPlainObject(a)){b=a;a=false}if(!b||b===this.ACTIVE)f=c.active.collection;else if(d.isString(b))f=c.sys.tmpCollection[b];else{g=true;f=b}if(f===null)return 0;if(g!==true)f=nimble.byLink(f,this.getActiveParam("context").toString());e=f.length;if(d.isString(f))return e;if(typeof f==="object")if(a===false&&e!==undefined)j=e;else{j=0;if(e!==undefined)f.forEach(function(k,l){if(this.customFilter(a,k,f,l,e||null,this,b?b:this.ACTIVE)===true)j+=1},this);else for(h in f)if(f.hasOwnProperty(h))if(this.customFilter(a,
f[h],f,h,e||null,this,b?b:this.ACTIVE)===true)j+=1}else throw Error("incorrect data type!");return j};d.Collection.fn.each=function(a,b,c,f,e,g,h){a=d.isFunction(a)?{filter:a}:a;b=d.isExist(b)?b:this.getActiveParam("filter");c=d.isExist(c)?c:this.ACTIVE;if(d.isBoolean(c)){h=g;g=e;e=f;f=c;c=this.ACTIVE}f=f===false?false:true;e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;h=parseInt(h)||false;var j=this.dObj,k,l,m,n=0;k=nimble.byLink(c!==this.ACTIVE?j.sys.tmpCollection[c]:j.active.collection,
this.getActiveParam("context").toString());l=this.length(k);if(d.isArray(k)){j=h!==false?k.slice(h):k;j.some(function(o,p){p+=h;if(e!==false&&n===e)return true;if(this.customFilter(b,o,k,p,l,this,c)===true)if(g!==false&&g!==0)g-=1;else{if(a.filter&&a.filter.call(a.filter,o,k,p,l,this,c)===false)return true;if(f===false)return true;n+=1}else if(a.denial&&(g===false||g===0)&&a.denial.call(a.denial,o,k,p,l,this,c)===false)return true;if(a.full&&(g===false||g===0)&&a.full.call(a.full,o,k,p,l,this,c)===
false)return true},this)}else for(m in k){if(k.hasOwnProperty(m)){if(e!==false&&n===e)break;if(h!==false&&h!==0){h-=1;continue}if(this.customFilter(b,k[m],k,m,l,this,c)===true)if(g!==false&&g!==0)g-=1;else{if(a.filter&&a.filter.call(a.filter,k[m],k,m,l,this,c)===false)break;if(f===false)break;n+=1}}else if(a.denial&&(g===false||g===0)&&a.denial.call(a.denial,k[m],k,m,l,this,c)===false)break;if(a.full&&(g===false||g===0)&&a.full.call(a.full,k[m],k,m,l,this,c)===false)break}return this};d.Collection.fn.searchElements=
function(a,b,c,f,e,g){a=d.isExist(a)?a:this.getActiveParam("filter");b=d.isExist(b)?b:this.ACTIVE;if(d.isBoolean(b)){g=e;e=f;f=c;c=b;b=this.ACTIVE}c=c===false?false:true;f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;g=parseInt(g)||false;var h=[];this.each(function(j,k,l){if(c===true)h.push(l);else{h=l;return false}return true},a,b,c,f,e,g);return h};d.Collection.fn.searchElement=function(a,b){return this.searchElements(a||"",b||"",false)};d.Collection.fn.returnElements=function(a,b,c,f,
e,g){a=d.isExist(a)?a:this.getActiveParam("filter");b=d.isExist(b)?b:this.ACTIVE;if(d.isBoolean(b)){g=e;e=f;f=c;c=b;b=this.ACTIVE}c=c===false?false:true;f=parseInt(f)>=0?parseInt(f):false;e=parseInt(e)||false;g=parseInt(g)||false;var h=[];this.each(function(j,k,l){if(c===true)h.push(k[l]);else{h=k[l];return false}return true},a,b,c,f,e,g);return h};d.Collection.fn.returnElement=function(a,b){return this.returnElements(a||"",b||"",false)};d.Collection.fn.replaceElements=function(a,b,c,f,e,g,h){a=d.isExist(a)?
a:this.getActiveParam("filter");c=d.isExist(c)?c:this.ACTIVE;if(d.isBoolean(c)){h=g;g=e;e=f;f=c;c=this.ACTIVE}f=f===false?false:true;e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;h=parseInt(h)||false;var j=d.isFunction(b);this.each(function(k,l,m,n,o,p){if(j)b.call(b,k,l,m,n,o,p);else l[m]=nimble.expr(b,l[m]);return true},a,c,f,e,g,h);return this};d.Collection.fn.replaceElement=function(a,b,c){return this.replaceElements(a||"",b,c||"",false)};d.Collection.fn.moveElements=function(a,b,c,
f,e,g,h,j,k,l){a=d.isExist(a)?a:this.getActiveParam("filter");l=l===false?false:true;b=d.isExist(b)?b.toString():"";c=c||"";f=f||"";e=e||"push";g=g===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=parseInt(j)||false;k=parseInt(k)||false;var m=[],n=d.isArray(nimble.byLink(this._get("collection",f),this.getActiveParam("context").toString()));this.disable("context");a=this.searchElements(a,c,g,h,j,k);this.enable("context");if(g===true)a.forEach(function(o){this.add(b+nimble.CHILDREN+o,n===true?
e:o+nimble.METHOD_SEPARATOR+e,f,c);l===true&&m.push(o)},this);else{this.add(b+nimble.CHILDREN+a,n===true?e:a+nimble.METHOD_SEPARATOR+e,f,c);l===true&&m.push(a)}l===true&&this.disable("context").deleteElementsByLink(m,c).enable("context");return this};d.Collection.fn.moveElement=function(a,b,c,f,e){return this.moveElements(a||"",d.isExist(b)?b.toString():"",c||"",f||"",e||"",false)};d.Collection.fn.copyElements=function(a,b,c,f,e,g,h,j,k){g=g===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=
...
0?parseInt(f):false;e=parseInt(e)||false;g=parseInt(g)||false;a=this.searchElements(a,b,c,f,e,g);if(c===false)this.deleteElementByLink(a,b);else for(c=a.length;(c-=1)>-1;)this.deleteElementByLink(a[c],b);return this};d.Collection.fn.deleteElement=function(a,b){return this.deleteElements(a||"",b||"",false)};d.Collection.fn.customFilter=function(a,b,c,f,e,g,h){var j=this.dObj,k=j.active;j=j.sys;var l,m,n,o=true,p,s,r,q=-1;if(a===false)return true;if(d.isFunction(a))return a.call(a,b,c,f,e,g,h);if(!a||
d.isString(a)&&d.trim(a)===this.ACTIVE){if(k.filter)return k.filter.call(k.filter,b,c,f,e,g,h);return true}else{if(!d.isArray(a)){if(a.search(/\|\||&&|!|\(|\)/)===-1)return j.tmpFilter[a].call(j.tmpFilter[a],b,c,f,e,g,h);a=d.trim(a.toString().replace(/\s*(\(|\))\s*/g," $1 ").replace(/\s*(\|\||&&)\s*/g," $1 ").replace(/(!)\s*/g,"$1")).split(" ")}m=function(t,w){for(var u=-1,y=t.length,v=0,x=[];(u+=1)<y;){w+=1;if(t[u]==="(")v+=1;if(t[u]===")")if(v===0)return{result:x,iter:w};else v-=1;x.push(t[u])}};
for(l=a.length;(q+=1)<l;)if(a[q]==="("||a[q]==="!("){if(a[q].substring(0,1)==="!"){r=true;a[q]=a[q].substring(1)}else r=false;n=m(a.slice(q+1),q);q=n.iter;n=this.customFilter(n.result,b,c,f,e,g,h);o=!p&&!s?r===true?!n:n:p?r===true?!n:n&&o:r===true?!n:n||o}else if(a[q]!==")"&&a[q]!=="||"&&a[q]!=="&&"){if(a[q].substring(0,1)==="!"){r=true;a[q]=a[q].substring(1)}else r=false;n=a[q]===this.ACTIVE?k.filter:j.tmpFilter[a[q]];n=n.call(n,b,c,f,e,g,h);o=!p&&!s?r===true?!n:n:p?r===true?!n:n&&o:r===true?!n:
n||o}else if(a[q]==="||"){p=false;s=true}else if(a[q]==="&&"){s=false;p=true}return o}};d.Collection.fn.customParser=function(a,b){var c=this.dObj,f=c.active,e=c.sys,g;if(a===false)return b;if(d.isFunction(a))return a.call(a,b,this);if(!a||d.isString(a)&&d.trim(a)===this.ACTIVE){if(f.parser)return f.parser.call(f.parser,b,this)}else{if(d.isString(a)){a=d.trim(a);if(a.search("&&")===-1)return e.tmpParser[a].call(e.tmpParser[a],b,this);a=a.split("&&")}a.forEach(function(h){h=d.trim(h);g=h===this.ACTIVE?
f.parser:e.tmpParser[h];b=g.call(g,b,this)},this)}return b};d.Collection.fn.parentContext=function(a,b){a=a||1;var c="",f;c=this._get("collection",b||"").split(nimble.CHILDREN);for(f=a;(f-=1)>-1;)c.splice(-1,1);return c.join(nimble.CHILDREN)};d.Collection.fn.parent=function(a,b){var c=this.dObj,f=c.sys;c=c.active;var e=f.contextID,g=this.parentContext.apply(this,arguments);if(!b||b===this.ACTIVE){if(e)f.tmpContext[e]=g;c.context=g}else{f.tmpContext[b]=g;if(e&&b===e)c.context=g}return this};d.Collection.fn.orderBy=
function(a,b,c,f){a=a||null;b=b||false;c=c?c===false?null:c:function(j){if(isNaN(j))return j.toUpperCase();return j};f=f||"";var e,g=function(j){var k=[],l={},m;for(m in j)j.hasOwnProperty(m)&&k.push(m);k.sort(statObj.sort.sortBy(a,b,c));for(m in k)if(k.hasOwnProperty(m))l[k[m]]=j[k[m]];return l},h=function(j){var k=[],l={},m;for(m in j)j.hasOwnProperty(m)&&k.push({key:m,value:j[m]});k.sort(statObj.sort.sortBy(a===true?"value":"value"+statObj.obj.contextSeparator+a,b,c));for(m in k)if(k.hasOwnProperty(m))l[k[m].key]=
k[m].value;return l};e=nimble.byLink(this._get("collection",f),this.getActiveParam("context").toString());if(typeof e==="object")if(d.isArray(e))e.sort(d.Collection.sort.sortBy(a,b,c));else{e=a?h.call(this,e):g.call(this,e);this.set("",e,f||"")}else throw Error("incorrect data type!");return this};d.Collection.fn.toString=function(a,b,c){if(a&&(d.isArray(a)||d.isPlainObject(a))){if(JSON&&JSON.stringify)return JSON.stringify(a,b||"",c||"");throw Error("object JSON is not defined!");}a=nimble.byLink(this._get("collection",
a||""),this.getActiveParam("context").toString());if(JSON&&JSON.stringify)return JSON.stringify(a,b||"",c||"");throw Error("object JSON is not defined!");};d.Collection.fn.valueOf=function(a){return this.length(d.isExist(a)?a:this.ACTIVE)};d.Collection.fn.then=function(a,b){var c=this;arguments.length===1?d.when(c.active("defer")).always(function(){a.apply(c,arguments)}):d.when(c.active("defer")).then(function(){a().apply(c,arguments)},function(){b().apply(c,arguments)});return this};d.Collection.fn.print=
function(a,b,c){b=b||false;c=c||false;var f=this.dObj.active,e={},g,h,j=0,k=null,l="",m;if(d.isExist(a)&&(d.isString(a)||d.isNumeric(a)))a={page:a};else if(d.isBoolean(a))b=a;else d.isExist(a)||(a={page:f.page});d.extend(true,e,f,a);if(a)e.page=nimble.expr(e.page,f.page||"");if(e.page<1)e.page=1;e.collection=d.isString(e.collection)?this._get("collection",e.collection):e.collection;e.template=d.isString(e.template)?this._get("template",e.template):e.template;e.filter=d.isExist(a.filter)?a.filter:
this.getActiveParam("filter");e.parser=d.isExist(a.parser)?a.parser:this.getActiveParam("parser");if(c===true)e.cache.iteration=false;c=f.page-e.page;this.updatePage(e.page);m=function(n,o,p,s,r,q){e.callback&&e.callback.apply(this,arguments);l+=e.template.call(e.template,n,o,p,s,r,q);j=p;return true};a=nimble.byLink(e.collection,this.getActiveParam("context").toString()+nimble.CHILDREN+(a&&a.context||""));g=this.length();e.numberBreak=!b||e.numberBreak===false?g:e.numberBreak;if(d.isPlainObject(a)||
e.cache.iteration===false||e.cache.firstIteration===false||e.cache.lastIteration===false){h=!b||e.page===1?0:(e.page-1)*e.numberBreak;this.each(m,e.filter,this.ACTIVE,true,e.numberBreak,h);if(e.cache.iteration===false)e.cache.lastIteration=false}else if(d.isArray(a)&&e.cache.iteration===true){h=!b||e.filter===false?e.page===1?0:(e.page-1)*e.numberBreak:e.cache.iteration===true?c>=0?e.cache.firstIteration:e.cache.lastIteration:i;if(c>0&&b===true&&e.filter!==false){for(c*=e.numberBreak;(h-=1)>-1;)if(this.customFilter(e.filter,
a[h],a,h,g,this,this.ACTIVE)===true)if(j===c)break;else j+=1;e.cache.lastIteration=h+=1;k=null}else if(c<0&&b===true&&e.filter!==false)k=Math.abs(c)*e.numberBreak-e.numberBreak||null;this.each(m,e.filter,this.ACTIVE,true,e.numberBreak,k,h)}if(c!==0&&e.cache.iteration!==false){f.cache.firstIteration=e.cache.lastIteration;f.cache.lastIteration=j+1}if(e.cache.autoIteration===true)f.cache.iteration=true;l=!l?e.resultNull:this.customParser(e.parser,l);if(e.target===false){e.variable?this._push("variable",
e.variable,l):this._$("variable",l);return this}else e.target[e.appendType](l);if(!b)return this;e.nmbOfEntries=e.filter!==false?this.length(e.filter):g;e.nmbOfEntriesInPage=e.target.find(e.calculator).length;e.finNumber=e.numberBreak*e.page-(e.numberBreak-e.nmbOfEntriesInPage);e.page!==1&&e.nmbOfEntriesInPage===0?this.updatePage(e.page-=1).print(e,true,true):this.easyPage(e);return this};d.Collection.fn.easyPage=function(a){var b="",c=a.nmbOfEntries%a.numberBreak!==0?~~(a.nmbOfEntries/a.numberBreak)+
...
a.finNumber===a.nmbOfEntries)k.addClass(m&&m.disabled||"disabled");else if(l.nav==="prev"||l.nav==="next")k.removeClass(m&&m.disabled||"disabled");if(l.nav==="pageList"){if(c>a.pageBreak){g=a.pageBreak%2!==0?1:0;j=h=(a.pageBreak-g)/2;if(a.page-g<h)h=0;else{h=a.page-h-g;if(a.page+j>c)h-=a.page+j-c}e=h;for(g=-1;(e+=1)<=c&&(g+=1)!==null;){if(g===a.pageBreak&&e!==a.page)break;b+=f(l,m||"",e)}}else for(e=0;(e+=1)<=c;)b+=f(l,m||"",e);k.html(b)}}else if(l.info){a.nmbOfEntriesInPage===0?k.addClass(m&&m.noData||
"noData"):k.removeClass(m&&m.noData||"noData");switch(l.info){case "page":k.html(a.page);break;case "total":k.html(a.nmbOfEntries);break;case "from":k.html((a.page-1)*a.numberBreak+1);break;case "to":k.html(a.finNumber);break;case "inPage":k.html(a.nmbOfEntriesInPage);break;case "nmbOfPages":k.html(a.nmbOfPages)}}});return this};d.Collection.fn.genTable=function(a,b,c){a=a||4;b=b||"div";c=c===false?false:true;var f=1,e,g=this.dObj.active.target,h=g.find(b).length,j="";g.find(b).each(function(k){this.tagName!==
