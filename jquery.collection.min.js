...
false)this._removeOne(j,b);else for(h=j.length;(h-=1)>-1;)this._removeOne(j[h],b);return this};c.Collection.fn.removeOne=function(a,b){return this.remove(c.isExist(a)?a:"",b||"",false)};c.Collection.fn.save=function(a,b){if(!localStorage)throw Error("your browser does't support web storage!");if(!JSON)throw Error("object JSON is not defined!");a=a||this.ACTIVE;(b===false?false:true)===false?sessionStorage.setItem("__collection"+a,this.toString(a)):localStorage.setItem("__collection"+a,this.toString(a));
return this};c.Collection.fn.load=function(a,b){if(!localStorage)throw Error("your browser does't support web storage!");a=a||this.ACTIVE;if((b===false?false:true)===false)a===this.ACTIVE?this._new("collection",sessionStorage.getItem("__collection"+a)):this._push("collection",a,c.parseJSON(sessionStorage.getItem("__collection"+a)));else a===this.ACTIVE?this._new("collection",c.parseJSON(localStorage.getItem("__collection"+a))):this._push("collection",a,c.parseJSON(localStorage.getItem("__collection"+
a)));return this};c.Collection.fn.drop=function(a,b){if(!localStorage)throw Error("your browser does't support web storage!");a=a||this.ACTIVE;(b===false?false:true)===false?sessionStorage.removeItem("__collection"+a):localStorage.removeItem("__collection"+a);return this};c.Collection.fn._customFilter=function(a,b,d,f,e,g,j){var h=this.dObj,k=h.active;h=h.sys;var l,m,n,o=true,q,r,s,p=-1;if(a===false)return true;if(c.isFunction(a))return a.call(a,b,d,f,e,g,j);if(!a||c.isString(a)&&c.trim(a)===this.ACTIVE){if(k.filter){if(c.isFunction(k.filter))return k.filter.call(k.filter,
