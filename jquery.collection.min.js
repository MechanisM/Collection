...
"map","variable","defer","page","parser","appendType","target","calculator","pager","template","numberBreak","pageBreak","resultNull"],getActiveParam:function(a){return this.dObj.sys.flags.use[a]===undefined||this.dObj.sys.flags.use[a]===true?this.dObj.active[a]:""},enable:function(a){this.dObj.sys.flags.use[a]=true;return this},disable:function(a){this.dObj.sys.flags.use[a]=false;return this},toggle:function(a){if(this.dObj.sys.flags.use[a]===true)return this.disable(a);return this.enable(a)}};e.fn.collection=
function(a){var b=e.fn.collection.stat,d=function(f){var g=[];f.each(function(j){var h=e(this),k=h.data(),l=h.attr("class")?h.attr("class").split(" "):"",m=l?l.length:0,n;n=h[0];n=n.childNodes;for(var p=n.length,r=-1,q="";++r<p;)if(n[r].nodeType===3&&e.trim(n[r].textContent))q+=n[r].textContent;n=q?q:false;var o;g.push({});for(o in k)if(k.hasOwnProperty(o))g[j][o]=k[o];if(m){m--;g[j][b.classes]={};for(o=-1;++o<=m;)g[j][b.classes][l[o]]=l[o]}if(h.children().length!==0)g[j][b.childNodes]=d(h.children());
if(n!==false)g[j][b.val]=n.replace(/[\r\t\n]/g," ")});return g},c=d(this);if(a)return new e.Collection(c,a);return new e.Collection(c)};if(!e.fn.collection.stat)e.fn.collection.stat={val:"val",childNodes:"childNodes",classes:"classes"};e.fn.ctplCompile=function(){if(this.length===0)throw Error("DOM element isn't exist!");for(var a=this.html().replace(/\/\*.*?\*\//g,"").split("?>").join("<?js").replace(/[\r\t\n]/g," ").split("<?js"),b=a.length,d="var key = i, result = ''; ",c=-1;++c<b;)d+=c===0||c%
2===0?"result +='"+a[c]+"';":a[c].split("echo").join("result +=");return new Function("data","i","cOLength","self","id",d+" return result;")};e.fn.ctplMake=function(a){this.find("[type='text/ctpl']").each(function(){var b=e(this),d=b.data(),c=d.prefix?d.prefix+"_":"";a.pushTemplate(c+d.name,b.ctplCompile());d.set&&d.set===true&&a.setTemplate(c+d.name)})};e.isString=function(a){return nimble.isString(a)};e.isBoolean=function(a){return Object.prototype.toString.call(a)==="[object Boolean]"};e.isExist=
