...
d.Collection.prototype._getActiveParam=function(a){var b=this.dObj.sys.flags.use[a]===undefined||this.dObj.sys.flags.use[a]===true?this.dObj.active[a]:false;if(a==="context")return b?b.toString():"";return b};d.Collection.prototype._filterTest=function(a){return a===this.ACTIVE||this._exist("filter",a)||a.search(/&&|\|\||:/)!==-1};d.Collection.prototype.enable=function(a){this.dObj.sys.flags.use[a]=true;return this};d.Collection.prototype.disable=function(a){this.dObj.sys.flags.use[a]=false;return this};
...
d.Collection.prototype.then=function(a,b){var c=this;arguments.length===1?d.when(this.active("defer")).always(function(){a.apply(c,arguments)}):d.when(this.active("defer")).then(function(){a().apply(c,arguments)},function(){b().apply(c,arguments)});return this};d.Collection.prototype.print=function(a,b,c){b=b||false;c=c||false;var e={},g,f,h=0,j=null,k="",l;if(d.isExist(a)&&(d.isString(a)||d.isNumeric(a)))a={page:a};else if(d.isBoolean(a))b=a;else d.isExist(a)||(a={page:this._get("page")});d.extend(true,
...
"pageList"){if(c>a.pageBreak){f=a.pageBreak%2!==0?1:0;j=h=(a.pageBreak-f)/2;if(a.page-f<h)h=0;else{h=a.page-h-f;if(a.page+j>c)h-=a.page+j-c}g=h;for(f=-1;(g+=1)<=c&&(f+=1)!==null;){if(f===a.pageBreak&&g!==a.page)break;b+=e(l,m||"",g)}}else for(g=0;(g+=1)<=c;)b+=e(l,m||"",g);k.html(b)}}else if(l.info){a.nmbOfEntriesInPage===0?k.addClass(m&&m.noData||"noData"):k.removeClass(m&&m.noData||"noData");switch(l.info){case "page":k.html(a.page);break;case "total":k.html(a.nmbOfEntries);break;case "from":k.html((a.page-
1)*a.numberBreak+1);break;case "to":k.html(a.finNumber);break;case "inPage":k.html(a.nmbOfEntriesInPage);break;case "nmbOfPages":k.html(a.nmbOfPages)}}});return this};d.Collection.prototype.genTable=function(a,b,c){a=a||4;b=b||"div";c=c===false?false:true;var e=1,g,f=this._get("target"),h=f.find(b).length,j="";f.find(b).each(function(k){this.tagName!=="td"&&d(this).wrap("<td></td>");if(e===a){j="";for(g=-1;(g+=1)<a;){j+="td:eq("+(k-g)+")";if(g!==a-1)j+=","}f.find(j).wrapAll("<tr></tr>");e=0}else if(k===
h-1&&e!==a){j="";for(g=-1;(g+=1)<e;){j+="td:eq("+(k-g)+")";if(g!==e-1)j+=","}e-=1;f.find(j).wrapAll("<tr></tr>");if(c===true){for(j="";(e+=1)<a;)j+="<td></td>";f.find("tr:last").append(j)}}e+=1});f[0].tagName!=="table"&&f.children("tr").wrapAll("<table></table>");return this}})(jQuery);
//