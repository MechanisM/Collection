...
" ")});return h},g=e(this);if(a)return new d.Collection(g,a);return new d.Collection(g)};if(!d.fn.collection.stat)d.fn.collection.stat={val:"val",childNodes:"childNodes",classes:"classes"};d.fn.ctplCompile=function(){if(this.length===0)throw Error("DOM element isn't exist!");var a="var key = i, result = ''; ";this.html().replace(/\/\*.*?\*\//g,"").split("?>").join("<?js").replace(/[\r\t\n]/g," ").split("<?js").forEach(function(b,c){a+=c===0||c%2===0?"result +='"+b+"';":b.split("echo").join("result +=")});
...
function(a,b,c){return this._drop(a,b||"","",c===undefined?false:c)};d.Collection.prototype._resetTo=function(a,b,c){c=!c||c===this.ACTIVE?this.dObj.active[a]:this.dObj.sys["tmp"+d.toUpperCase(a,1)][c];return this._reset(a,b||"",c)};d.Collection.prototype._exist=function(a,b){var c=d.toUpperCase(a,1);if((!b||b===this.ACTIVE)&&this.dObj.sys["active"+c+"ID"])return true;if(this.dObj.sys["tmp"+c][b]!==undefined)return true;return false};d.Collection.prototype._isActive=function(a,b){if(b===this.dObj.sys["active"+
d.toUpperCase(a,1)+"ID"])return true;return false};d.Collection.prototype.use=function(a){for(var b=this.stack.length;(b-=1)>-1;)this._exist(this.stack[b],a)&&this._set(this.stack[b],a);return this};d.Collection.prototype._prop=function(a,b,c){var e=this.dObj[a];if(arguments.length!==3)if(d.isPlainObject(b))d.extend(e,b);else return e[b];else e[b]=c;return this};d.Collection.prototype.active=function(){return this._prop.apply(this,d.unshiftArguments(arguments,"active"))};(function(a){var b=d.Collection.prototype,
c;a.forEach(function(e){c=d.toUpperCase(e,1);b["new"+c]=function(g){return function(f){return this._new(g,f)}}(e);b["update"+c]=function(g){return function(f){return this._update(g,f)}}(e);b["reset"+c+"To"]=function(g){return function(f,h){return this._resetTo(g,f,h)}}(e);b["push"+c]=function(g){return function(){return this._push.apply(this,d.unshiftArguments(arguments,g))}}(e);b["set"+c]=function(g){return function(f){return this._set(g,f)}}(e);b["pushSet"+c]=function(g){return function(f,h){return this._push(g,
f,h)._set(g,f)}}(e);b["back"+c]=function(g){return function(f){return this._back(g,f||"")}}(e);b["back"+c+"If"]=function(g){return function(f){return this._backIf(g,f||"")}}(e);b["drop"+c]=e==="filter"||e==="parser"?function(g){return function(){return this._drop(g,arguments)}}(e):function(g){return function(){return this._drop(g,arguments,null)}}(e);if(e==="filter"||e==="parser")b["reset"+c]=function(g){return function(){return this._reset(g,arguments)}}(e);else if(e==="page")b["reset"+c]=function(g){return function(){return this._reset(g,
arguments,1)}}(e);else if(e==="context")b["reset"+c]=function(g){return function(){return this._reset(g,arguments,"")}}(e);b["isActive"+c]=function(g){return function(f){return this._isActive(g,f)}}(e);b["exist"+c]=function(g){return function(f){return this._exist(g,f||"")}}(e);b["get"+c]=function(g){return function(f){return this._get(g,f||"")}}(e)})})(d.Collection.prototype.stack);d.Collection.prototype._setOne=function(a,b,c){a=d.isExist(a)?a.toString():"";b=b===undefined?"":b;c=c||"";var e=this._getActiveParam("context");
if(!a&&!e)return c&&c!==this.ACTIVE?this._push("collection",c,b):this._update("collection",b);nimble.byLink(this._get("collection",c),e+nimble.CHILDREN+a,b);return this};d.Collection.prototype._getOne=function(a,b){a=d.isExist(a)?a.toString():"";return nimble.byLink(this._get("collection",b||""),this._getActiveParam("context")+nimble.CHILDREN+a)};d.Collection.prototype.add=function(a,b,c,e,g){a=a!==undefined?a:"";b=b||"push";c=c||"";g=g||false;var f,h,j;f=nimble.byLink(this._get("collection",c),this._getActiveParam("context"));
if(typeof f==="object"){if(e){a=d.isExist(a)?a.toString():"";h=nimble.byLink(this._get("collection",e||""),a);if(d.isPlainObject(f)){b=b==="push"?this.length(f):b==="unshift"?this.length(f)+nimble.METHOD_SEPARATOR+"unshift":b;j=nimble.addElementToObject(f,b.toString(),h)}else{j=true;f[b](h)}g===true&&this.disable("context")._removeOne(a,e).enable("context")}else if(d.isPlainObject(f)){b=b==="push"?this.length(f):b==="unshift"?this.length(f)+nimble.METHOD_SEPARATOR+"unshift":b;j=nimble.addElementToObject(f,
b.toString(),a)}else{j=true;f[b](a)}j!==true&&this._setOne("",j,c)}else throw Error("unable to set property!");return this};d.Collection.prototype.push=function(a,b){return this.add(a,"",b||"")};d.Collection.prototype.unshift=function(a,b){return this.add(a,"unshift",b||"")};d.Collection.prototype._removeOne=function(a,b){a=d.isExist(a)?a.toString():"";var c=this._getActiveParam("context");!a&&!c?this._setOne("",null):nimble.byLink(this._get("collection",b||""),c+nimble.CHILDREN+a,"",true);return this};
...
if(typeof j!=="object")throw Error("incorrect data type!");k=this.length(j);if(d.isArray(j)){l=h!==false?j.slice(h):j;l.some(function(q,p){p+=h;if(g!==false&&m===g)return true;if(this._customFilter(b,q,p,j,k,this,c)===true)if(f!==false&&f!==0)f-=1;else{if(a.filter)n=a.filter.call(a.filter,q,p,j,k,this,c)===false;if(e===false)n=true;m+=1}else if(a.denial&&(f===false||f===0)){o=a.denial.call(a.denial,q,p,j,k,this,c);if(n===false&&o===false)n=true}if(a.full&&(f===false||f===0)){o=a.full.call(a.full,
q,p,j,k,this,c);if(n===false&&o===false)n=true}if(n===true)return true;o=""},this)}else for(l in j){if(j.hasOwnProperty(l)){if(g!==false&&m===g)break;if(h!==false&&h!==0){h-=1;continue}if(this._customFilter(b,j[l],l,j,k,this,c)===true)if(f!==false&&f!==0)f-=1;else{if(a.filter)n=a.filter.call(a.filter,j[l],l,j,k,this,c)===false;if(e===false)n=true;m+=1}}else if(a.denial&&(f===false||f===0)){o=a.denial.call(a.denial,j[l],l,j,k,this,c);if(n===false&&o===false)n=true}if(a.full&&(f===false||f===0)){o=
a.full.call(a.full,j[l],l,j,k,this,c);if(n===false&&o===false)n=true}if(n===true)break;o=""}return this};d.Collection.prototype.search=function(a,b,c,e,g,f){a=d.isExist(a)&&a!==true?a:this._getActiveParam("filter");b=d.isExist(b)?b:this.ACTIVE;if(d.isBoolean(b)){f=g;g=e;e=c;c=b;b=this.ACTIVE}c=c===false?false:true;e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;f=parseInt(f)||false;var h=c===true?[]:-1;this.forEach(function(j,k){if(c===true)h.push(k);else h=k;return true},a,b,c,e,g,f);return h};
d.Collection.prototype.searchOne=function(a,b){return this.search(d.isExist(a)?a:"",b||"",false)};d.Collection.prototype.indexOf=function(a,b,c){c=c||"";b=b||"";var e=nimble.byLink(this._get("collection",c),this._getActiveParam("context"));if(d.isArray(e)&&e.indexOf){if(b)return e.indexOf(a,b);return e.indexOf(a)}else return this.search(function(g){return g===a},c,false,"","",b)};d.Collection.prototype.lastIndexOf=function(a,b,c){c=c||"";b=b||"";var e=nimble.byLink(this._get("collection",c),this._getActiveParam("context"));
if(d.isArray(e)&&e.lastIndexOf){if(b)return e.lastIndexOf(a,b);return e.lastIndexOf(a)}else{b=this.search(function(g){return g===a},c,"","","",b);return b[b.length-1]!==undefined?b[b.length-1]:-1}};d.Collection.prototype.get=function(a,b,c,e,g,f){if(d.isNumeric(a)||arguments.length<2&&d.isString(a)&&!this._filterTest(a)||arguments.length===0||arguments.length<2&&a===null)return this._getOne(a,b||"");a=d.isExist(a)&&a!==true?a:this._getActiveParam("filter");b=d.isExist(b)?b:this.ACTIVE;if(d.isBoolean(b)){f=
g;g=e;e=c;c=b;b=this.ACTIVE}c=c===false?false:true;e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;f=parseInt(f)||false;var h=c===true?[]:-1;this.forEach(function(j,k,l){if(c===true)h.push(l[k]);else h=l[k];return true},a,b,c,e,g,f);return h};d.Collection.prototype.getOne=function(a,b){return this.get(d.isExist(a)?a:"",b||"",false)};d.Collection.prototype.set=function(a,b,c,e,g,f,h){if(d.isNumeric(a)||arguments.length<3&&d.isString(a)&&!this._filterTest(a)||arguments.length===0||arguments.length<
...
"",b,c||"",false)};d.Collection.prototype.map=function(a,b){return this.set(true,a,b||"")};d.Collection.prototype.some=function(a,b,c){return this.forEach(a,b||"",c||"",false)};d.Collection.prototype.move=function(a,b,c,e,g,f,h,j,k,l){a=d.isExist(a)&&a!==true?a:this._getActiveParam("filter");l=l===false?false:true;b=d.isExist(b)?b.toString():"";c=c||"";e=e||"";g=g||"push";f=f===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=parseInt(j)||false;k=parseInt(k)||false;var m=[],n=d.isArray(nimble.byLink(this._get("collection",
e),this._getActiveParam("context")));this.disable("context");a=this.search(a,c,f,h,j,k);this.enable("context");if(f===true)a.forEach(function(o){this.add(b+nimble.CHILDREN+o,n===true?g:o+nimble.METHOD_SEPARATOR+g,e,c);l===true&&m.push(o)},this);else{this.add(b+nimble.CHILDREN+a,n===true?g:a+nimble.METHOD_SEPARATOR+g,e,c);l===true&&m.push(a)}l===true&&this.disable("context")._remove(m,c).enable("context");return this};d.Collection.prototype.moveOne=function(a,b,c,e,g){return this.move(d.isExist(a)?
a:"",d.isExist(b)?b.toString():"",c||"",e||"",g||"",false)};d.Collection.prototype.copy=function(a,b,c,e,g,f,h,j,k){f=f===false?false:true;h=parseInt(h)>=0?parseInt(h):false;j=parseInt(j)||false;k=parseInt(k)||false;return this.move(d.isExist(a)?a:"",d.isExist(b)?b.toString():"",c||"",e||"",g||"push",f,h,j,k,false)};d.Collection.prototype.copyOne=function(a,b,c,e,g){return this.move(d.isExist(a)?a:"",d.isExist(b)?b.toString():"",c||"",e||"",g||"",false,"","","",false)};d.Collection.prototype.remove=
function(a,b,c,e,g,f){if(d.isNumeric(a)||arguments.length<2&&d.isString(a)&&!this._filterTest(a)||arguments.length===0||arguments.length<2&&a===null)return this._removeOne(a,b||"");else if(d.isArray(a)||d.isPlainObject(a))return this._remove(a,b||"");a=d.isExist(a)&&a!==true?a:this._getActiveParam("filter");b=d.isExist(b)?b:this.ACTIVE;if(d.isBoolean(b)){f=g;g=e;e=c;c=b;b=this.ACTIVE}c=c===false?false:true;e=parseInt(e)>=0?parseInt(e):false;g=parseInt(g)||false;f=parseInt(f)||false;var h=this.search(a,
b,c,e,g,f),j;if(c===false)this._removeOne(h,b);else for(j=h.length;(j-=1)>-1;)this._removeOne(h[j],b);return this};d.Collection.prototype.removeOne=function(a,b){return this.remove(d.isExist(a)?a:"",b||"",false)};d.Collection.prototype.sort=function(a,b,c,e){a=a||null;b=b||false;c=c&&c!==true?c===false?null:c:function(l){if(isNaN(l))return l.toUpperCase();return l};e=e||"";var g=this,f,h=function(l,m){var n=b?-1:1;if(a){l=nimble.byLink(l,a);m=nimble.byLink(m,a)}if(c){l=c(l);m=c(m)}if(b!==g.SHUFFLE){if(l<
m)return n*-1;if(l>m)return n;return 0}else return Math.round(Math.random()*2-1)},j=function(l){var m=[],n={},o;for(o in l)l.hasOwnProperty(o)&&m.push(o);m.sort(h);for(o in m)if(m.hasOwnProperty(o))n[m[o]]=l[m[o]];return n},k=function(l){var m=[],n={},o;for(o in l)l.hasOwnProperty(o)&&m.push({key:o,value:l[o]});a=a===true?"value":"value"+nimble.CHILDREN+a;m.sort(h);for(o in m)if(m.hasOwnProperty(o))n[m[o].key]=m[o].value;return n};f=nimble.byLink(this._get("collection",e),this._getActiveParam("context"));
if(typeof f==="object")if(d.isArray(f))f.sort(h);else{f=a?k(f):j(f);this._setOne("",f,e)}else throw Error("incorrect data type!");return this};d.Collection.prototype.reverse=function(a){a=a||"";var b,c=function(e){var g=[],f={},h;for(h in e)e.hasOwnProperty(h)&&g.push(h);g.reverse();for(h in g)if(g.hasOwnProperty(h))f[g[h]]=e[g[h]];return f};b=nimble.byLink(this._get("collection",a),this._getActiveParam("context"));if(typeof b==="object")d.isArray(b)?b.reverse():this._setOne("",c(b),a);else throw Error("incorrect data type!");
return this};d.Collection.prototype.save=function(a,b){if(!localStorage)throw Error("your browser does't support web storage!");a=a||this.ACTIVE;if((b===false?b:true)===false){sessionStorage.setItem("__"+this.name+":"+a,this.toString(a));sessionStorage.setItem("__"+this.name+"__date:"+a,(new Data).toString())}else{localStorage.setItem("__"+this.name+":"+a,this.toString(a));localStorage.setItem("__"+this.name+"__date:"+a,(new Data).toString())}return this};d.Collection.prototype.load=function(a,b){if(!localStorage)throw Error("your browser does't support web storage!");
